...
public class DroppedFileHandler {
	...
	public static void drop(DropTargetDropEvent evt, final IFrameMediator kseFrame) {
...
*/
			...
			DError.displayError(kseFrame.getContainer().getFrame(), e);
	...
	public static void openFiles(IFrameMediator kseFrame, List<File> droppedFiles) {
