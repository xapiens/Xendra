...
public class CreateApplicationGui implements Runnable {
	...
	public void run() {
		try {
			...
			final IFrameMediator kseFrame = new SecurityEditorFrameController(null);
	...
	private void checkCaCerts(final IFrameMediator kseFrame) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				int selected = JOptionPane.showConfirmDialog(kseFrame.getContainer().getFrame(), MessageFormat.format(
	...
	private void checkForUpdates(final IFrameMediator kseFrame) {
		new Thread() {
			@Override
			public void run() {
				try {
					...
					SwingUtilities.invokeLater(new Runnable() {
						...
						public void run() {
							...
							CheckUpdateAction checkUpdateAction = new CheckUpdateAction(null);
	...
	private void integrateWithMacOs(IFrameMediator kseFrame) throws ClassNotFoundException, SecurityException,
