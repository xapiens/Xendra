...
public class DeleteTrustedCertificateAction extends SecurityColumbaAction implements HistoryAction {

	public DeleteTrustedCertificateAction(IFrameMediator frameMediator) {
		super(frameMediator, ResourceLoader.getString("menu", "mainframe", "DeleteTrustedCertificate"));
		putValue(Constants.ID, "DeleteTrustedCertificate");
		putValue(SHORT_DESCRIPTION, ResourceLoader.getString("menu","mainframe","DeleteTrustedCertificate"));
		putValue(TOOLBAR_NAME, ResourceLoader.getString("menu", "mainframe","DeleteTrustedCertificate"));
