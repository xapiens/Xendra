...
public class showReplica implements Runnable {
	MultiWindowTextGUI gui;
	Table<String> table;
	public showReplica(MultiWindowTextGUI gui, Table<String> table) {
		this.gui = gui;
		this.table = table;
	}
	...
	public void run() {
		...
		String id = row.get(0);
		String sql = "Select errormsg,processed from a_xendrian_replication where a_xendrian_replication_id = ?";
		try {
