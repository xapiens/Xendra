 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: XendraButtonListener.java,v 1.1 2007/06/14 23:44:20 sergioaguayo Exp $
 */
public class XendraButtonListener extends BasicButtonListener
{
	/**
	 * 	Adempiere Button Listener
	 *	@param b button
	 */
	public XendraButtonListener (AbstractButton b)
	{
		super (b);
