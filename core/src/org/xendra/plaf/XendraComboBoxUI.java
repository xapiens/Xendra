 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: AdempiereComboBoxUI.java,v 1.1 2007/06/14 23:44:20 sergioaguayo Exp $
 */
public class XendraComboBoxUI extends com.jgoodies.looks.plastic.PlasticComboBoxUI
{
	/**
	 *  Create UI
	 *  @param c
	...
	{
		XendraComboPopup newPopup = new XendraComboPopup( comboBox );
