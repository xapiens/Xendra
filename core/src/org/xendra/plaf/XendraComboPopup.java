 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: AdempiereComboPopup.java,v 1.1 2007/06/14 23:44:19 sergioaguayo Exp $
 */
public class XendraComboPopup extends BasicComboPopup
{
	/**
	 *  Constructor
	 *  @param combo
	 */
	public XendraComboPopup(JComboBox combo)
	{
		super(combo);
	}   //  AdempiereComboPopup
