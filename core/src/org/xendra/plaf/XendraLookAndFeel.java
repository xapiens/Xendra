 ...
 */
public class XendraLookAndFeel extends com.jgoodies.looks.plastic.Plastic3DLookAndFeel
{
	/**
	 *  Constructor
	 */
	public XendraLookAndFeel()
	{
		super();
	...
	/** The name                    */
	public static final     String  NAME = "Xendra";

	/** The Theme                   */
	private static          PlasticTheme  s_xendraTheme = new org.xendra.plaf.XendraTheme();
	private static          PlasticTheme      s_theme = s_xendraTheme;
	...
	public static final String HIDE_IF_ONE_TAB = "xendra.hideIfOneTab";	
	/**
	 *  The Name
	 *  @return Name
	 */
	...
	{
		return "Xendra Look & Feel - (c) 2008 Francisco Morosini";
	}   //  getDescription
	...
	private void putDefault (UIDefaults table, String uiKey)
	{
		try
		{
			String className = "org.xendra.plaf.Xendra" + uiKey;
	...
	/**
	 *  Get default Xendra theme
	 *  @return Metal Theme
	 */
	public static PlasticTheme getDefaultTheme()
	{
		return s_xendraTheme;
	}   //  getCurrentTheme
