...
/**
 * 	Xendra default Blue Metal Color Theme
 *	
 *  @author Jorg Janke, Adam Michau
 *  @version $Id: XendraThemeInnova.java,v 1.1 2007/06/14 23:44:19 sergioaguayo Exp $
 */
public class XendraThemeInnova extends org.xendra.plaf.XendraTheme
{
	/**
	 * 	Adempiere default Theme Blue Metal
	 */
	public XendraThemeInnova()
	{
		setDefault();
		s_theme = this;
		s_name = NAME;
	...
	/**	Name			*/
	public static final String	NAME = "Xendra Theme";
	...
	secondary2= new ColorUIResource(0, 0, 0);
