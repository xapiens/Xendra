 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: XendraPLAF.java,v 1.1 2007/06/14 23:44:19 sergioaguayo Exp $
 *  
 *  @author Low Heng Sin
 *  @version 2006-11-27
 */
public final class XendraPLAF
{
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(XendraPLAF.class.getName());
	...
	private static ValueNamePair    s_vp_xendraTheme = null;
	...
	static
	{
		...
		try
		{
			...
			vp = new ValueNamePair("org.xendra.plaf.XendraLookAndFeel", org.xendra.plaf.XendraLookAndFeel.NAME);
			plafList.add(vp);
			s_vp_xendraTheme = new ValueNamePair("org.xendra.plaf.XendraThemeGreen", XendraThemeGreen.NAME);
			plasticThemes.add (s_vp_xendraTheme);
			
			List installedThemes = XendraLookAndFeel.getInstalledThemes();
		...
		for (int i = 0; i < lfInfo.length; i++)
		{
			...
			plafList.add(vp);
			if (lfInfo[i].getName().equals(org.xendra.plaf.XendraLookAndFeel.NAME))
			{
				s_defaultPLAF = vp;
	...
	public static ValueNamePair[] getThemes ()
	{
		...
		if ( l instanceof XendraLookAndFeel)
	...
	public static void setPLAF (ValueNamePair plaf, ValueNamePair theme, boolean updateIni)
	{
		...
		boolean xendra = XendraLookAndFeel.class.isAssignableFrom(lafClass);
		...
		if (theme != null && metal && theme.getValue().length() > 0)
		{
			try
			{
				...
				else if (xendra && t instanceof PlasticTheme)
					XendraLookAndFeel.setCurrentTheme((PlasticTheme)t);
				else 
	...
	{
		return UIManager.getLookAndFeel() instanceof XendraLookAndFeel;
	}   //  isActive
	...
	{
		CButton b = new CButton();
		b.setIcon(new ImageIcon(XendraPLAF.class.getResource("icons/Cancel24.gif")));
		b.setMargin(new Insets(0,10,0,10));
	...
	public static void setCurrentMetalTheme(MetalLookAndFeel laf, MetalTheme theme)
	{
		...
		else if (laf instanceof XendraLookAndFeel && theme instanceof PlasticTheme)
			XendraLookAndFeel.setCurrentTheme((PlasticTheme)theme);
		else 
