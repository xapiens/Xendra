...
public class PluginSearchProvider implements ISearchProvider {
	public static final String CRITERIA_TAG_CONTAINS = "tag_contains";
	...
	public String getTechnicalName() {
		return "PluginSearchProvider";
	}

	@Override
	public String getName() {
		return bundle.getString("plugin_title");
	}
	...
	public ImageIcon getIcon() {
    	ImageIcon icon = null;	
		try {
    		icon  = new ImageIcon(ImageIO.read(new File(Env.getResource("org.columba.core", "plugin.png"))));
    	}
    	catch (Exception e) {}
    	return icon;
	}
	...
	public List<ISearchCriteria> getAllCriteria(String searchTerm) {
		...
		list.add(getCriteria(PluginSearchProvider.CRITERIA_TAG_CONTAINS, searchTerm));		
		return list;
	}
	...
	public ICriteriaRenderer getCriteriaRenderer(String criteriaTechnicalName) {
		...
		if (criteriaTechnicalName.equals(PluginSearchProvider.CRITERIA_TAG_CONTAINS)) {
			r = new StringCriteriaRenderer(getCriteria(PluginSearchProvider.CRITERIA_TAG_CONTAINS, ""),
					this);
		}
		return r;
	}
	...
	public ISearchCriteria getDefaultCriteria(String searchTerm) {
		return getCriteria(PluginSearchProvider.CRITERIA_TAG_CONTAINS, searchTerm);
	}
