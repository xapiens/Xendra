...
public class InfoAssignment extends AbstractColumbaAction{

	/**
	 * @param frameMediator
	 * @param name
	 */
	public InfoAssignment(IFrameMediator frameMediator) {
		super(frameMediator, Msg.getMsg(Env.getCtx(),"InfoAssignment"));
	...
	public void actionPerformed(ActionEvent e) {
		int WindowNo = 0;
		org.compiere.apps.search.Info.showAssignment((Frame) this.frameMediator.getView().getFrame(), WindowNo, "");
	}
}
