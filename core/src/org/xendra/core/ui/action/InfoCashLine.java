...
public class InfoCashLine extends AbstractColumbaAction{

	/**
	 * @param frameMediator
	 * @param name
	 */
	public InfoCashLine(IFrameMediator frameMediator) {
		super(frameMediator, Msg.getMsg(Env.getCtx(),"InfoCashLine"));
	...
	public void actionPerformed(ActionEvent e) {
		int WindowNo = 0;
		org.compiere.apps.search.Info.showCashLine((Frame) this.frameMediator.getView().getFrame(), WindowNo, "");
	}
}
