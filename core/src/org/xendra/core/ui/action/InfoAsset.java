...
public class InfoAsset extends AbstractColumbaAction{

	/**
	 * @param frameMediator
	 * @param name
	 */
	public InfoAsset(IFrameMediator frameMediator) {
		super(frameMediator, Msg.getMsg(Env.getCtx(),"InfoAsset"));
	...
	public void actionPerformed(ActionEvent e) {
		int WindowNo = 0;
		org.compiere.apps.search.Info.showAsset((Frame) this.frameMediator.getView().getFrame(), WindowNo);
	}
}
