...
public class InfoOrder extends AbstractColumbaAction{

	/**
	 * @param frameMediator
	 * @param name
	 */
	public InfoOrder(IFrameMediator frameMediator) {
		super(frameMediator, Msg.getMsg(Env.getCtx(),"InfoOrder"));
	...
	public void actionPerformed(ActionEvent e) {
		int WindowNo = 0;
		org.compiere.apps.search.Info.showOrder((Frame) this.frameMediator.getView().getFrame(), WindowNo, "");
	}
}
