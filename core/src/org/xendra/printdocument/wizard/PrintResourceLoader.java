...
public class PrintResourceLoader extends GlobalResourceLoader {
    protected static final String PRINT_RESOURCE_PATH = "org.xendra.printdocument.i18n";

    /**
 * No need for creating instances of this class.
 */
    private PrintResourceLoader() {
    }
    ...
    public static String getString(String sPath, String sName, String sID) {
        return GlobalResourceLoader.getString(generateBundlePath(
                PRINT_RESOURCE_PATH, sPath), sName, sID);
    }
    ...
    public static String getString(String sName, String sID) {
        return GlobalResourceLoader.getString(generateBundlePath(
                PRINT_RESOURCE_PATH, sName), sName, sID);
    }
}
