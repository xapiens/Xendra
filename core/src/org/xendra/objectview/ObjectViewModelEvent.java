 ...
 */
public class ObjectViewModelEvent extends java.util.EventObject {
    /**
     ...
     */
    public ObjectViewModelEvent(ObjectViewModel pSource) {
     ...
     */
    public ObjectViewModelEvent(ObjectViewModel pSource, Object pRowObject) {
     ...
     */
    public ObjectViewModelEvent(ObjectViewModel pSource, Collection pRowObjects) {
