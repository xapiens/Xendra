 ...
 *
 */
public interface IObjetViewColumn {
    /**
    ...
    /**
     * Return true if the cell is the description 
     * @param none.
     * @return true if the cell is the description
     */
    ...
    /**
     * Return true if the cell is the next line indicator
     * @param none.
     * @return true if the cell is the next line indicator
     */
    ...
    /**
     * Return true if the cell is the default indicator
     * @param none.
     * @return true if the cell is the default indicator
     */
     ...
     * Return if is Key 
     *
     * @return true if it is Key search
     */    
