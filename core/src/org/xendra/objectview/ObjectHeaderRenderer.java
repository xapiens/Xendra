 ...
 *
 */
public class ObjectHeaderRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable pTable,
        ...
        ObjectViewAdapter model = (ObjectViewAdapter) pTable.getModel();
        ...
        if (pTable != null) {
            ...
            if (header != null) {
                ...
                Font font = new Font(header.getFont().getFontName(), Font.BOLD, header.getFont().getSize());
                setFont(font);
            }
        }
