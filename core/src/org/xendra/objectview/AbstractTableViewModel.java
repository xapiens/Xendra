...
public abstract class AbstractTableViewModel
     ...
     */
    public void addTableViewModelListener(ObjectViewModelListener pListner) {
        mListenerList.add(ObjectViewModelListener.class, pListner);
    }
     ...
     * @param pListner the TableModelListener
     */
    public void removeTableViewModelListener(ObjectViewModelListener pListner) {
        mListenerList.remove(ObjectViewModelListener.class, pListner);
    }
    ...
    protected void fireTableDataChanged() {
        fireTableChanged(new ObjectViewModelEvent(this));
    }
    ...
    protected void fireTableRowsInserted(Collection pRowObjects) {
        fireTableChanged(new ObjectViewModelEvent(this, pRowObjects,
                ObjectViewModelEvent.INSERT));
    }
    ...
    protected void fireTableRowInserted(Object pRowObject) {
        fireTableChanged(new ObjectViewModelEvent(this, pRowObject,
                ObjectViewModelEvent.INSERT));
    }
     ...
     * @see EventListenerList
     */
    protected void fireTableChanged(ObjectViewModelEvent pEvent) {
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == ObjectViewModelListener.class) {
                ((ObjectViewModelListener) listeners[i + 1])
