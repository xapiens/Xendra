...
/**
 * Any exception that occurs inside the Xendra core
 * @author Teo Sarca, SC ARHIPAC SERVICE SRL
 */
public class XendraException extends RuntimeException {
	/**
	 * 
	 */
	 ...
	 * @param message
	 */
	public XendraException(String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public XendraException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause
	 */
	public XendraException(String message, Throwable cause) {
		super(message, cause);
	}
