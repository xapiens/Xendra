...
public class NewDatabase extends AbstractStep {
	...
	protected JComponent createComponent() {
		...
		progress.setTitle("Haga click para empezar");
			...
			public void mouseClicked(MouseEvent evt) {
				if (!inprocess) {
					int selected = JOptionPane.showConfirmDialog(null, 
							ResourceLoader.getString("dialog", "newclient", "initialize"),
							ResourceLoader.getString("dialog", "newclient", "initializeTitle"), 
	...
	class Task extends SwingWorker {
		...
		public Object construct() {
			...
			try {
				...
				try {
					URL createtablesx = getClass().getResource("createtables.zip");							
					File createtables = new File(createtablesx.toURI());
					if (createtables.exists()) {										
						ZipInputStream zin = new ZipInputStream(new FileInputStream(createtables.getAbsolutePath()));
						ZipEntry ze = null; 
			...
			try {
				...
				URL filltablesx = getClass().getResource("filltables.zip");									
				File filltables = new File(filltablesx.toURI());
				if (filltables.exists()) {
					ZipInputStream zin = new ZipInputStream(new FileInputStream(filltables.getAbsolutePath()));
					ZipEntry ze = null; 
					while ((ze = zin.getNextEntry()) != null) {
