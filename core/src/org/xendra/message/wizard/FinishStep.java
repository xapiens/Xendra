...
class FinishStep extends AbstractStep {
    public FinishStep() {
        super(ResourceLoader.getString("dialog", "messagewizard", "finish"),
        	  ResourceLoader.getString("dialog", "messagewizard", "finish_description"));
        setCanFinish(true);
    }
    ...
    protected JComponent createComponent() {
        ...
        MultiLineLabel label = new MultiLineLabel(ResourceLoader.getString(
                    "dialog", "messagewizard", "finish_text"));
        component.add(label);
