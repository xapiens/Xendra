 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: CompierePanelUI.java,v 1.1 2007/06/14 23:44:16 sergioaguayo Exp $
 */
public class CompierePanelUI extends BasicPanelUI
{
	...
	//	System.out.println ("BG=" + p.getClientProperty(XendraPLAF.BACKGROUND));
		if (s_setDefault || p.getClientProperty(XendraPLAF.BACKGROUND) == null)
			p.putClientProperty (XendraPLAF.BACKGROUND, s_default);
		/** **/
	}   //  installDefaults
