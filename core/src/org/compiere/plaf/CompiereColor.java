 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: CompiereColor.java,v 1.1 2007/06/14 23:44:15 sergioaguayo Exp $
 */
public class CompiereColor implements Serializable
{
	...
	{
		setBackground (c, new CompiereColor(XendraPLAF.getFormBackground()));
	}   //  setBackground
	...
	{
		setBackground (win, new CompiereColor(XendraPLAF.getFormBackground()));
	}   //  setBackground
	...
	{
		return new CompiereColor(XendraPLAF.getFormBackground());
	...
	public URL getTextureURL()
	{
		...
		if (m_textureURL == null)
			m_textureURL = CompiereColor.class.getResource("Background.gif");
		return m_textureURL;
	}   //  getTextureURL
