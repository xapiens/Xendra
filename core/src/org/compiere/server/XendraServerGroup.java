 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: XendraServerGroup.java,v 1.1 2007/06/15 00:03:25 sergioaguayo Exp $
 */
public class XendraServerGroup extends ThreadGroup
{
	/**
	 * 	Get Xendra Server Group
	 *	@return Server Group
	 */
	public static XendraServerGroup get()
	{
		if (s_group == null || s_group.isDestroyed())
			s_group = new XendraServerGroup(); 
		return s_group;
	}	//	get
	
	/** Group */
	private static XendraServerGroup	s_group	= null;
	
	/**
	 * 	XendraServerGroup
	 */
	private XendraServerGroup ()
	{
		super ("XendraServers");
		setDaemon(true);
