...
import org.compiere.model.persistence.X_AD_Note;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: Scheduler.java,v 1.1 2007/06/15 00:03:25 sergioaguayo Exp $
 */
public class Scheduler extends XendraServer 
{
	...
	{
		super (model, 1);		//	nap		
		if (model.getTag().length() > 0 && model.getFrequencyType().equals(REF__FrequencyType.Notification))
		{
			Env.addPrinterNotification(this, model.getTag());
		}
		m_model = model;
