...
public final class Convert_PostgreSQLTest {
	...
	public void doTest() {
		...
		+ "SET PriceLastInv = "
		+ "(SELECT currencyConvert(il.PriceActual,0,i.C_Currency_ID,po.C_Currency_ID,i.DateInvoiced,i.C_ConversionType_ID,i.AD_Client_ID,i.AD_Org_ID) "
