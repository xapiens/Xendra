 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: ResultTableCellRenderer.java 899 2008-04-01 23:59:38Z el_man $
 */
class ResultTableCellRenderer extends DefaultTableCellRenderer implements TableCellRenderer
{
		...
		boolean isSelected, boolean hasFocus, int row, int col)
	{
		...
		if (m_rm.isCellEditable(row, col))
			c.setBackground(XendraPLAF.getFieldBackground_Normal());
		else
			c.setBackground(XendraPLAF.getFieldBackground_Inactive());
		//
