 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: RModel.java 4864 2013-05-02 16:00:10Z xapiens $
 * 
...
public class RModel implements Serializable
{
	...
	public int getColumnIndex (String columnName)
	{
		...
		//	log.fine( "Column " + i + " " + rc.getColSQL() + " ? " + columnName);
			//if (rc.getColSQL().startsWith(columnName)) <-- evita usar funciones complejas
			if (rc.getColSQL().contains(columnName))
			{
				log.fine( "Column " + i + " " + rc.getColSQL() + " = " + columnName);
				return i;
			}
...
//	}   //  query
	...
	{
		m_data.query (ctx, whereClause, SummarywhereClause, orderClause, summarized);
	}   //  query
