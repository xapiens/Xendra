 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MReportTree.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MReportTree
{
	...
	public MReportTree (Properties ctx, int PA_Hierarchy_ID, String ElementType)
	{
		...
		if (REF_C_AcctSchemaElementType.Account.equals(m_ElementType)
			|| REF_C_AcctSchemaElementType.UserList1.equals(m_ElementType)
			|| REF_C_AcctSchemaElementType.UserList2.equals(m_ElementType) )
			m_TreeType = REF_AD_TreeTypeType.ElementValue;
