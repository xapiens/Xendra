...
import org.compiere.model.persistence.X_PA_ReportLine;
 ...
 *
 *  @author Jorg Janke
 *  @version $Id: MReportLine.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MReportLine extends X_PA_ReportLine
{
	...
	{
		return REF_PA_ReportLineType.Calculation.equals(getLineType());
	}
	/**
	...
	{
		return REF_PA_ReportLineType.SegmentValue.equals(getLineType());
	}
	...
	{
		if (REF_PA_ReportLineType.SegmentValue.equals(getLineType()))
		{
