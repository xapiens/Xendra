 ...
 *
 *  @author Jorg Janke
 *  @version $Id: FileUtil.java 1071 2009-01-05 20:41:57Z xapiens $
 */
public class FileUtil
{
	 ...
	 * 	 \textsl{\colorbox{yellow}{\textbf{Important:}}} For more information on the
		installation of the Xendra Server and the Xendra Client please refer to
		\href{http://www.xendra.org/support/index.html}{Xendra Support} for more details and the latest
		update.
	 * 	@param file file
	 * 	@throws IOException
	 */
	...
	{
		String directory = "C:\\Xendra\\xendra-all2";
		String filter = ".java";
	//	String action = "License";	//	Replace
	//	String from = null;	
	//	String to = null;
		String action = "Replace";
		String from = "$Id: FileUtil.java 1071 2009-01-05 20:41:57Z xapiens $";	
		String to = "$Id: FileUtil.java 1071 2009-01-05 20:41:57Z xapiens $";
