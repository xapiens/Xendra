 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: SLAMeasureProcess.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class SLAMeasureProcess extends SvrProcess
{
	 ...
	 *	@throws Exception
	 */
//	@XendraProcess(value="PA_SLA_Measure_Calculate",
//	name="Calculate Measures",
//	description="Calculate the Measure",
//	help="Calculate/update the actual measure.",
//	id="21d517c0-cd68-4bb4-75e6-c0a7858fc586",
//	ParametersName={""},
//	ParametersType={},
//	ParametersSeqNo={},
//	ParametersReference={""},
...
//	ParametersReadOnlyLogic={""})	
	public String doIt () throws Exception
	{
		...
		if (measure.get_ID() == 0)
			throw new XendraUserError("@PA_SLA_Measure_ID@ " + p_PA_SLA_Measure_ID);
		
		MSLAGoal goal = new MSLAGoal(getCtx(), measure.getPA_SLA_Goal_ID(), get_TrxName());
		if (goal.get_ID() == 0)
			throw new XendraUserError("@PA_SLA_Goal_ID@ " + measure.getPA_SLA_Goal_ID());
