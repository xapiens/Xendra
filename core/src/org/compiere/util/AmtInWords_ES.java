 ...
 *  @version $Id: AmtInWords_ES.java 2176 2010-12-15 05:48:05Z xapiens $
 */
...
//		if( lang.isDecimalPoint() && amount.lastIndexOf ('.') > 0 )
//    	 pos = amount.lastIndexOf ('.');    // Old
//		else
...
//			pos2 = amount.lastIndexOf ('.');
		...
		if( amount.lastIndexOf (',') > 0 &&  amount.lastIndexOf (',') < pos )
			pos--;
		if( amount.lastIndexOf ('.') > 0 &&  amount.lastIndexOf ('.') < pos )
			pos--;
		...
		long pesos = Long.parseLong(amount.substring (0, pos));
