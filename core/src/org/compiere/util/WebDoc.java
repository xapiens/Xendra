 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: WebDoc.java 1146 2010-01-31 03:17:19Z xapiens $
 */
public class WebDoc
{
	/**
	...
	private void setUp (boolean plain, boolean javaClient, String title)
	{
		...
		//	css, js
		if (javaClient)
			m_head.addElement(new link("http://www.xendra.org/standard.css", link.REL_STYLESHEET, link.TYPE_CSS));
		else
		{
		...
		m_head.addElement(new meta().setName("description", "xendra HTML UI"));
		...
		if (javaClient)
			m_topRight.addElement(new img("http://www.xendra.org/components/com_fpss/images/thumbs/xsplash_1.jpg")
				.setAlign(AlignType.RIGHT).setAlt("www.xendra.org"));
		else
