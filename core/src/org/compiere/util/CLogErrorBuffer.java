 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CLogErrorBuffer.java 5735 2016-01-20 16:16:41Z xapiens $
 */
			...
			if (m_issueError)
			{
					...
					)
				{
					...
					StringBuilder sb = new StringBuilder(" SELECT count(*) ")
							   ...
							   .append("WHERE table_schema = 'xendra' ")
							   .append("AND  table_name = 'ad_issue' ");							   
					int records = DB.getSQLValue(null, sb.toString());
					if (records == 1)
