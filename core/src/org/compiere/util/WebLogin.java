 ...
 * You may reach us at: ComPiere, Inc. - http://www.xendra.org/license.html
 * 2620 Augustine Dr. #245, Santa Clara, CA 95054, USA or info@xendra.org 
 *****************************************************************************/
 ...
 *  @version $Id: WebLogin.java 5583 2015-08-05 14:11:58Z xapiens $
 */
		...
		else if ("SendEMail".equals(m_mode))
		{
			...
			else
			{
				...
				String msg = WebUtil.sendEMail (m_request, m_wu,
						REF_W_MailMsgType.UserPassword, new Object[]{
