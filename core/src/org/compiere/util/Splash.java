...
public class Splash extends JFrame
{
	...
	{
		String msg;
		if (Locale.getDefault().getLanguage().equals("es")) // espa??ol - globalqss
	...
	private void jbInit() throws Exception
	{
		...
		productLabel.setText(Xendra.getSubtitle());
	//	productLabel.setToolTipText(Xendra.getURL());
		//
		...
		this.add(aImage, BorderLayout.NORTH);
	...
	private class AImage extends Component
	{
		...
		{
			super();
			//URL url = org.compiere.Xendra.class.getResource("images/Java_anim.gif");
			//URL url = org.compiere.Xendra.class.getResource("images/background.png");
			URL url = org.compiere.Xendra.class.getResource("images/startup.png");
//			URL url = org.compiere.Xendra.class.getResource("images/Xendra.gif");
			if (url == null)
				url = org.compiere.Xendra.class.getResource("images/Java_logo.gif");
			if (url != null)
			{
