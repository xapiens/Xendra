 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: Evaluator.java 4091 2012-04-10 20:33:02Z xapiens $
 */
public class Evaluator
{
	...
	public static void parseDepends(ArrayList<String> list, String parseString, String parse)
	{
	...
	//	log.fine( "MField.parseDepends", parseString);
		...
		while (s.indexOf(parse) != -1)
		{
			int pos = s.indexOf(parse);
			s = s.substring(pos+1);
			pos = s.indexOf(parse);
			if (pos == -1)
