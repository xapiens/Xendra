 ...
 *  </pre>
 *  @author     Jorg Janke
 *  @version    $Id: DisplayType.java 5721 2016-01-02 23:13:51Z xapiens $
 * 
...
public final class DisplayType
{
	...
	/** Display Type 43	QAttribute	*/
	public static final int QAttribute = 43;	
	/** Display Type 44 ListCalc */
	public static final int RowChild   = 44;
	/** Display Type 45 XML */
	public static final int XML        = 45;
	/** Display Type 46 HStore */ 
	public static final int HStore     = 46;
	/** Display Type 47 Script */ 
	public static final int Script     = 47;
	//	Candidates: 
	 ...
	 *	- New Display Type
		...
		VALUES (35, 0,0,'Y',CURRENT_TIMESTAMP,0,CURRENT_TIMESTAMP,0,
	...
	public static boolean isID (int displayType)
	{
		if (displayType == ID || displayType == Table || displayType == TableDir
			...
			|| displayType == Account || displayType == Assignment || displayType == PAttribute || displayType == QAttribute
			|| displayType == Image )
			return true;
		return false;
	}	//	isID
	...
	/** 
	 * Return true if DisplayType is HStore
	 * @param displayType Display Type
	 * @return true if HStore
	 */
	public static boolean isHStore(int displayType)
	{
		if (displayType == HStore)
			return true;
		return false;
	}
	...
	public static Class getClass (int displayType, boolean yesNoAsBoolean)
	{
		if (isText(displayType) || displayType == List)
			...
			return String.class;
		else if (displayType == Script)
			return String.class;
		else if (displayType == HStore)
	 ...
	 */
	public static String getSQLDataType (int displayType, String columnName, int fieldLength, boolean isKey, boolean isParent)
	{
...
//			else if (displayType == DisplayType.ID && columnName.endsWith("_ID") && isKey && !isParent)
//				//return "SERIAL";
//				//return "NUMERIC NOT NULL DEFAULT nextval('"+columnName.toLowerCase().replace("_id", "")+"_"+columnName.toLowerCase()+"_seq'::regclass)";				
//				return "NUMERIC NOT NULL DEFAULT nextval('"+columnName.toLowerCase().replace("_id", "")+"_seq'::regclass)";
			else if  (displayType == DisplayType.ID && columnName.endsWith("_ID"))
				return "NUMERIC(10)";
		...
		if (displayType == DisplayType.HStore)
		{
			return "hstore";
		}
