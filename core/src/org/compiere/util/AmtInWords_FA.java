 ...
 *  @version $Id: AmtInWords_FA.java 508 2007-11-24 23:06:53Z el_man $
 */
public class AmtInWords_FA implements AmtInWords {
    ...
    private String convertLessThanOneThousand(int number) {
        ...
        if (number % 100 < 20) {
            ...
            number /= 100;
            soFar = hundredsNames[number] + (soFar=="" || hundredsNames[number]=="" ? soFar : " ?? " + soFar);
        } else {
            soFar = numNames[number % 10];
            number /= 10;
            soFar = tensNames[number % 10] + (tensNames[number % 10]=="" ? soFar : " ?? " + soFar);
            number /= 10;
            soFar = hundredsNames[number % 10] + (hundredsNames[number % 10]=="" ? soFar : " ?? " + soFar);
        }
        return soFar;
            ...
            if (n != 0) {
                ...
                if (soFar != "")
                    soFar = s + " " + majorNames[place] + 
                            (s=="" || majorNames[place]==""  ? soFar : " ?? " + soFar);
                else
                    soFar = s + " " + majorNames[place];
            }
            place++;
