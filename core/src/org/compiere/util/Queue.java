 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: Queue.java 508 2007-11-24 23:06:53Z el_man $
 */
...
/*
	...
	private static AQQueue createQueue(String name)
	{
		...
		try
		{
			...
			t_property.setComment("Xendra Client/Server Communication Table");
			t_property.setSortOrder("ENQ_TIME");
			t_property.setMultiConsumer(false);
		//	t_property.setCompatible("8.1");
			//	Create table in the Xendra scheme
			...
			q_property.setComment("Xendra Client/Server Communication Queue");
