 ...
 *
 *  @author Jorg Janke
 *  @version $Id: WebInfo.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class WebInfo
{
	...
	public ArrayList<MOrder> getOrders()
	{
		...
		if (m_wu != null && 
			!m_wu.hasBPAccess(REF_AD_UserBPAccessType.BusinessDocuments, 
				new Object[] {REF_C_DocTypeDocBaseType.PurchaseOrder, REF_C_DocTypeDocBaseType.SalesOrder}))
		{
			log.info("No Access");
			return list;
		}
	...
	public ArrayList<MInOut> getShipments()
	{
		...
		if (m_wu != null && 
			!m_wu.hasBPAccess(REF_AD_UserBPAccessType.BusinessDocuments, 
				new Object[] {REF_C_DocTypeDocBaseType.MaterialReceipt, REF_C_DocTypeDocBaseType.MaterialDelivery}))
		{
			log.info("No Access");
			return list;
		}
	...
	public ArrayList<MInvoice> getInvoices()
	{
		...
		if (m_wu != null && 
			!m_wu.hasBPAccess(REF_AD_UserBPAccessType.BusinessDocuments, 
				new Object[] {REF_C_DocTypeDocBaseType.APInvoice, REF_C_DocTypeDocBaseType.APCreditMemo,
				REF_C_DocTypeDocBaseType.ARInvoice, REF_C_DocTypeDocBaseType.ARCreditMemo}))
		{
			log.info("No Access");
			return list;
		}
	...
	public ArrayList<MPayment> getPayments()
	{
		...
		if (m_wu != null && 
			!m_wu.hasBPAccess(REF_AD_UserBPAccessType.BusinessDocuments, 
				new Object[] {REF_C_DocTypeDocBaseType.APPayment, REF_C_DocTypeDocBaseType.ARReceipt}))
		{
			log.info("No Access");
			return list;
		}
	...
	public ArrayList<MAsset> getAssets()
	{
		...
		if (m_wu != null && 
			!m_wu.hasBPAccess(REF_AD_UserBPAccessType.AssetsDownload, null))
		{
			log.info("No Access");
			return list;
		}
