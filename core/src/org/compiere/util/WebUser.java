 ...
 *  @author Jorg Janke
 *  @version $Id: WebUser.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class WebUser
{
	...
	public boolean isCreditCritical()
	{
		...
		return REF_C_BPartnerSOCreditStatus.CreditStop.equals(status)
			...
			|| REF_C_BPartnerSOCreditStatus.CreditWatch.equals(status);
	}
	...
	{
		return MRefList.getListName(m_ctx, REF_C_BPartnerSOCreditStatus.Identifier, m_bp.getSOCreditStatus());
	}	//	getSOCreditStatus
