 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CCachedRowSet.java 2993 2011-05-19 22:04:18Z xapiens $
 */
public class CCachedRowSet extends CachedRowSetImpl /*implements CachedRowSet*/
{
	 ...
	 *	@throws SQLException
	 */
	public static RowSet getRowSet (String sql, Connection conn, XendraDatabase db) throws SQLException
	{
	 ...
	 *	@throws SQLException
	 */
	public static RowSet getRowSet (ResultSet rs, XendraDatabase db) throws SQLException
	{
		if (db.getName().equals(Database.DB_ORACLE))
		{
			//OracleCachedRowSet crs = new OracleCachedRowSet();
