 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: XendraUserError.java 863 2008-03-19 23:07:19Z el_man $
 */
public class XendraUserError extends Exception
{
	/**
	 * 	Adempiere User Error
	 *	@param message message
	 */
	public XendraUserError (String message)
	{
		super (message);
	}	//	AdempiereUserError
	 ...
	 */
	public XendraUserError (String message, String fixHint)
	{
		super (message);
		setFixHint(fixHint);
	}	//	AdempiereUserError
	 ...
	 *	@param cause
	 */
	public XendraUserError (String message, Throwable cause)
	{
		super (message, cause);
	}	//	AdempiereUserError
