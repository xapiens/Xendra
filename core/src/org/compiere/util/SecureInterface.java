 ...
 * 	To enable your own class, you need to set the property XENDRA_SECURE 
 * 	when starting the client or server.
 *  The setting for the default class would be:
 *  -DXENDRA_SECURE=org.compiere.util.Secure
 *	
 *  @author Jorg Janke
 *  @version $Id: SecureInterface.java,v 1.1 2007/06/14 23:44:23 sergioaguayo Exp $
 */
public interface SecureInterface
{
	/** Class Name implementing SecureInterface	*/
	public static final String	XENDRA_SECURE = "XENDRA_SECURE";
	/** Default Class Name implementing SecureInterface	*/
	public static final String	XENDRA_SECURE_DEFAULT = "org.compiere.util.Secure";
