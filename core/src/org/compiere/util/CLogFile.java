 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CLogFile.java 5735 2016-01-20 16:16:41Z xapiens $
 */
public class CLogFile extends Handler
{
	...
	private boolean createFile(String baseDirName, boolean createLogDir, boolean isClient)
	{
		...
		try
		{
			...
			//	Test/Create XendraHome/log/file
			if (fileName != null)
			{
			...
			if (m_file == null)		//	Fallback create temp file
				m_file = File.createTempFile("xendra", ".log");
		}
		catch (Exception ex)
		{
