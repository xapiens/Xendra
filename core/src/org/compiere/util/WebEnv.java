 ...
 *
 *  @author Jorg Janke
 *  @version $Id: WebEnv.java 1146 2010-01-31 03:17:19Z xapiens $
 */
public class WebEnv
{
	/** Add HTML Debug Info                     */
	...
	/**
	 *  Base Directory links <b>http://localhost:8080/xendra</b>
	 *  to the physical <i>%adempiere_HOME%/tomcat/webroot/xendra</i> directory
	 */
	public static final String   	DIR_BASE    = "/xendra";      //  /adempiere
	...
	private static final String     LOGO        = "LogoSmall.gif";  //  /xendra/LogoSmall.gif
	/** Store Sub-Directory under BASE          */
	private static final String     DIR_STORE   = "store";          //  /xendra/store
	...
	/** Cookie Name                             */
	public static final String      COOKIE_INFO = "xendraInfo";
	 ...
	 *	Removing/modifying the Xendra logo or copyright notice is a violation of the license
	 *  @return Image
	 */
	public static img getLogo()
	{
		...
		//	and you'll be held liable for any damage claims
			.setAlt("&copy; Jorg Janke/Xendra.org");	
	}   //  getLogo
		...
		HttpServlet servlet, body body)
	{
		...
		//  Command Line
		p footer = new p();
		footer.addElement(org.compiere.Xendra.DATE_VERSION + ": ");
