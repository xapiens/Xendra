...
public class WindowMenu extends JMenu {
    ...
    public WindowMenu(WindowManager windowManager, JFrame frame) {
        ...
        closeAll.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
            	...
            	Environment.getWindowManager().close();
            }
        });
        ...
        closeOthers.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
            	...
            	Environment.getWindowManager().closeOthers((CFrame) WindowMenu.this.frame);
            }
        });
    ...
    private void buildChildMenus() {
        ...
        CFrame[] array = Environment.getWindowManager().getWindows();
    ...
    class Loader implements Runnable {
		...
		public void run() {
			...
			CFrame[] w = Environment.getWindowManager().getWindows();
