 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: ALoginTest.java 865 2008-03-20 00:23:42Z el_man $
 */
	...
	implements ActionListener, Runnable
{
	...
	public void run ()
	{
		...
		if (!testJDBC(host, jdbcPort, m_dbName, m_uid, m_pwd))
		{
			...
			{
				inform ("Please check XENDRA user id and password");
				inform (".... and please change SYSTEM password");
				return;
			}
		}

		inform ("*** Xendra database found: " + host + ":" + jdbcPort + "/" +  m_dbName + " ***");
		if (m_worker != null && m_worker.isInterrupted())
			return;
