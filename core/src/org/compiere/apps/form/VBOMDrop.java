 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: VBOMDrop.java 5498 2014-12-22 06:24:51Z xapiens $
 */
	...
	implements FormPanel, ActionListener
{
	...
	private void addBOMLine (MProductBOM line, BigDecimal qty)
	{
		...
		if (bomType == null)
			bomType = REF_M_ProductBOMProductTypeX.StandardPart;
		//
		...
		int M_Product_ID, String bomType, String name, BigDecimal lineQty)
	{
		...
		if (REF_M_ProductBOMProductTypeX.StandardPart.equals(bomType))
		{
			String title = "";
		...
		else if (REF_M_ProductBOMProductTypeX.OptionalPart.equals(bomType))
		{
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (source == productField || source == productQty)
		{
			...
			m_product = MProduct.get (Env.getCtx(), pp.getKey(), null);
			createMainPanel();
			sizeIt();
		}
