 ...
 *
 *  @author Jorg Janke
 *  @version $Id: VCharge.java 5498 2014-12-22 06:24:51Z xapiens $
 */
	...
	implements FormPanel, ActionListener
{
	...
	private void createNew()
	{
		...
		if (value.length() == 0)
		{
			valueField.setBackground(XendraPLAF.getFieldBackground_Error());
			return;
		}
		String name = nameField.getText();
		if (name.length() == 0)
		{
			nameField.setBackground(XendraPLAF.getFieldBackground_Error());
			return;
		}
		//  Create Element
	...
	private int create_ElementValue (String value, String name, boolean isExpenseType)
	{
		...
		MElementValue ev = new MElementValue(Env.getCtx(), value, name, null,
			isExpenseType ? REF_C_ElementValueAccountType.Expense : REF_C_ElementValueAccountType.Revenue, 
				REF_C_ElementValueAccountSign.Natural,
				false, false, null);
