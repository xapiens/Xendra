 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: BarGraph.java 508 2007-11-24 23:06:53Z el_man $
 */
public class BarGraph extends CPanel implements ActionListener
{
	...
	private void loadData()
	{
		...
		if (REF_PA_MeasureType.Calculated.equals(measure.getMeasureType()))
		{
			MMeasureCalc mc = MMeasureCalc.get(Env.getCtx(), measure.getPA_MeasureCalc_ID());
			String sql = mc.getSqlBarChart(m_goal.getRestrictions(false), m_goal.getMeasureDisplay(), null, MRole.getDefault());	//	logged in role
		...
		else if (REF_PA_MeasureType.Achievements.equals(measure.getMeasureType()))
		{
			if (REF_PA_MeasureDataType.StatusQtyAmount.equals(measure.getMeasureDataType()))
			{
			...
			else	//	REF_PA_MeasureDataType.QtyAmountInTime	
			{
		...
		//	Request
		else if (REF_PA_MeasureType.Request.equals(measure.getMeasureType()))
		{
		...
		//	Project
		else if (REF_PA_MeasureType.Project.equals(measure.getMeasureType()))
		{
