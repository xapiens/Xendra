 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: BarGraphColumn.java 508 2007-11-24 23:06:53Z el_man $
 */
public class BarGraphColumn extends JComponent implements MouseListener
{
	...
	public void setLabel (Timestamp date, String MeasureDisplay)
	{
		...
		//	Month only
		if (REF_PA_GoalScope.Month.equals(MeasureDisplay)
			|| REF_PA_GoalScope.Quarter.equals(MeasureDisplay))
		{
