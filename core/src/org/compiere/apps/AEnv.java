 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: AEnv.java 5219 2014-02-08 13:35:13Z xapiens $
 *  
...
public final class AEnv
{
	...
	//	}
		...
		else if (actionCommand.equals("InfoBOE") && AEnv.canAccessInfo("BOE"))
		{
			org.compiere.apps.search.Info.showBOE (Env.getFrame(c), WindowNo);
		}		
...
//		}
		...
		else if (actionCommand.equals("Script"))
		{
			...
			//String s = ScriptEditor.start (
			//		Env.getFrame(c),
			//		"groovy", "jython", true /* isEditable() */, WindowNo);			
		}
		...
		{
			Env.startBrowser(org.compiere.Xendra.getOnlineHelpURL());
		}
...
//	
	...
	*/ 
	...
	public static JButton getDarkButton(Icon icon, String name, String description)
	{
		...
		if (icon != null)
		{
			...
			final ImageIcon darkerIcon = new ImageIcon(
					Toolkit.getDefaultToolkit().createImage(
							new FilteredImageSource(imgicon.getImage().getSource(), filter)));
	...
	public static JButton createActionButton(AppsAction action,
	        ...
	        String image,
	        String tooltip) {
		final ImageIcon icon = Env.getImageIcon2(image);
		final JButton result = new JButton();
		if (icon == null)
		{
			return (JButton) action.getButton();
		}
