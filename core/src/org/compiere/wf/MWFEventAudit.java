...
import org.compiere.model.persistence.X_AD_WF_EventAudit;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MWFEventAudit.java 5583 2015-08-05 14:11:58Z xapiens $
 * 
...
public class MWFEventAudit extends X_AD_WF_EventAudit
{
	...
	public MWFEventAudit (MWFActivity activity)
	{
		...
		setEventType (REF_WF_EventType.ProcessCreated);
		...
		if (node != null && node.get_ID() != 0)
		{
			...
			if (REF_WF_Action.SetVariable.equals(action)
				|| REF_WF_Action.UserChoice.equals(action))
			{
