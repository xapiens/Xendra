...
import org.compiere.model.persistence.X_AD_WF_NodeNext;
 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MWFNodeNext.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MWFNodeNext extends X_AD_WF_NodeNext
{
		...
		if (isStdUserWorkflow())
		{
			...
			if (po instanceof DocAction)
			{
				...
				if (!DocAction.ACTION_Complete.equals(docAction)
					...
					|| DocAction.STATUS_Placed.equals(docStatus)
					|| DocAction.STATUS_Returned.equals(docStatus)
	...
	public boolean isToJoinAnd ()
	{
		if (m_toJoinAnd == null && getAD_WF_Next_ID() != 0)
		{
			...
			setToJoinAnd(REF_WF_Join_Split.AND.equals(next.getJoinElement()));
		}
		if (m_toJoinAnd != null)
