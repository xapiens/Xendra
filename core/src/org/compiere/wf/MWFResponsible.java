...
import org.compiere.model.persistence.X_AD_WF_Responsible;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MWFResponsible.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MWFResponsible extends X_AD_WF_Responsible
{
	...
	{
		return REF_WF_ParticipantType.Role.equals(getResponsibleType()) 
			&& getAD_Role_ID() != 0;
	}	//	isRole
	...
	{
		return REF_WF_ParticipantType.Human.equals(getResponsibleType()) 
			&& getAD_User_ID() != 0;
	}	//	isHuman
	...
	{
		return REF_WF_ParticipantType.Organization.equals(getResponsibleType()) 
			&& getAD_Org_ID() != 0;
	}	//	isOrg
	...
	{
	//	if (REF_WF_ParticipantType.Human.equals(getResponsibleType()) && getAD_User_ID() == 0)
	//		return true;
		if (REF_WF_ParticipantType.Role.equals(getResponsibleType()) 
			&& getAD_Role_ID() == 0
			&& getAD_Client_ID() > 0)
		{
		...
		if (!REF_WF_ParticipantType.Human.equals(getResponsibleType()) && getAD_User_ID() == 0)
			setAD_User_ID(0);
		//	Role not used
		if (!REF_WF_ParticipantType.Role.equals(getResponsibleType()) && getAD_Role_ID() == 0)
			setAD_Role_ID(0);
		return true;
	}	//	beforeSave
