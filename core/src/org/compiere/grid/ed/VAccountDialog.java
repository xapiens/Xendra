 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: VAccountDialog.java 3839 2011-12-17 17:01:15Z xapiens $
 */
	...
	implements ActionListener, DataStatusListener, VetoableChangeListener
{
	...
	void jbInit() throws Exception
	{
		...
		bSave.setIcon(new ImageIcon(org.compiere.Xendra.class.getResource("images/Save24.png")));
		bSave.setIcon(Env.getImageIcon2("Save24"));
		bSave.setMargin(new Insets(2, 2, 2, 2));
		bSave.setToolTipText(Msg.getMsg(Env.getCtx(),"AccountNewUpdate"));
		bSave.addActionListener(this);
		bRefresh.setIcon(new ImageIcon(org.compiere.Xendra.class.getResource("images/Refresh24.gif")));
		bRefresh.setMargin(new Insets(2, 2, 2, 2));
		bRefresh.setToolTipText(Msg.getMsg(Env.getCtx(),"Refresh"));
		bRefresh.addActionListener(this);
		bIgnore.setIcon(new ImageIcon(org.compiere.Xendra.class.getResource("images/Ignore24.gif")));
	...
	private boolean initAccount()
	{
		...
		for (int i = 0; i < elements.length; i++)
		{
			...
			//
			if (type.equals(REF_C_AcctSchemaElementType.Organization))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.Account))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.SubAccount))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.Product))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.BPartner))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.Campaign))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.LocationFrom))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.LocationTo))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.Project))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.SalesRegion))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.OrgTrx))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.Activity))
			{
			...
			//	User1
			else if (type.equals(REF_C_AcctSchemaElementType.UserList1))
			{
			...
			else if (type.equals(REF_C_AcctSchemaElementType.UserList2))
			{
