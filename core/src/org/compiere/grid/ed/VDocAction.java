 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: VDocAction.java 5004 2013-08-13 15:44:32Z xapiens $
 */
	...
	implements ActionListener
{
	...
	private boolean 			showAcct = "Y".equals(Env.getContext(Env.getCtx(), "#ShowAcct")); 
	...
	private VDate fDate = new VDate("Date", false, false, true, DisplayType.Date, Msg.translate(Env.getCtx(), "Date"));	
	...
	void jbInit() throws Exception
	{
		...
		message.setBackground(XendraPLAF.getFieldBackground_Inactive());
		...
		northPanel.add(fDate,null); // el_man
	...
	private void dynInit(int Record_ID)
	{
		...
		//	Draft/Invalid				..  DR/IN
			...
			|| DocStatus.equals(DocumentEngine.STATUS_Invalid) ) && m_AD_Table_ID != MBOE.Table_ID )
		{
			options[index++] = DocumentEngine.ACTION_Placed; // xapiens
			options[index++] = DocumentEngine.ACTION_Complete;
		//	options[index++] = DocumentEngine.ACTION_Prepare;
			options[index++] = DocumentEngine.ACTION_Returned; // xapiens
			if (showAcct)
				options[index++] = DocumentEngine.ACTION_Void;
		}		
		...
		{
			options[index++] = DocumentEngine.ACTION_Placed;
			if (m_AD_Table_ID != MAllocationHdr.Table_ID)
				options[index++] = DocumentEngine.ACTION_Restore;
			if (showAcct)
				options[index++] = DocumentEngine.ACTION_Close;
		}
		else if (DocStatus.equals(DocumentEngine.STATUS_Placed))
		{
			options[index++] = DocumentEngine.ACTION_Returned;
			if (showAcct)
				options[index++] = DocumentEngine.ACTION_Void;
			options[index++] = DocumentEngine.ACTION_Complete;
		}
		else if (DocStatus.equals(DocumentEngine.STATUS_Returned))
		{			
			if (showAcct)
				options[index++] = DocumentEngine.ACTION_Void;
			options[index++] = DocumentEngine.ACTION_Placed;
		...
		HashMap docstates = (HashMap) Env.getstates(m_AD_Table_ID);
		if (docstates != null)
		{
			List<String>  nextstates = (List<String>) docstates.get(DocStatus);
			if (nextstates != null)
			{
...
//		{
//			//int test = DocumentEngine.getValidActions(DocStatus, Processing, OrderType, IsSOTrx, m_AD_Table_ID, options ,options);
//			//	Draft                       ..  DR/IP/IN
...
//			if (DocStatus.equals(DocumentEngine.STATUS_Completed))
//			{
//				//options[index++] = DocumentEngine.ACTION_Placed; // el_man
//				if (showAcct)
//					options[index++] = DocumentEngine.ACTION_Void;
//				options[index++] = DocumentEngine.ACTION_Reverse_Correct;				
//			}
...
//		}
//		
//		else if (m_AD_Table_ID == MWithholdingHdr.Table_ID)
//		{
//			if (DocStatus.equals(DocumentEngine.STATUS_Completed))
//			{
//				if (showAcct)
//					options[index++] = DocumentEngine.ACTION_Void;
//				
//				options[index++] = DocumentEngine.ACTION_ToCollect;
//			}
//			else if (DocStatus.equals(DocumentEngine.STATUS_ToCollect))
//				options[index++] = DocumentEngine.ACTION_Collect;
//			else if (DocStatus.equals(DocumentEngine.STATUS_Collect))
//				options[index++] = DocumentEngine.ACTION_Apply;
//			else if (DocStatus.equals(DocumentEngine.STATUS_Apply) && showAcct)
//				options[index++] = DocumentEngine.ACTION_Close;							
//		}
//		/********************
//		 *  GL Journal
...
//		 * Bill of Exchange
//		 */
//		else if (m_AD_Table_ID == MBOE.Table_ID)
//		{
//			if (DocStatus.equals(DocumentEngine.STATUS_Portfolio))
//			{
//				options[index++] = DocumentEngine.ACTION_Warranty;
//				options[index++] = DocumentEngine.ACTION_Discount;
//				options[index++] = DocumentEngine.ACTION_Receivables;
//				options[index++] = DocumentEngine.ACTION_Protested;
//				//options[index++] = DocumentEngine.ACTION_Reverse_Correct;
//			}			
//			else if (DocStatus.equals(DocumentEngine.ACTION_Warranty))
//			{
//				options[index++] = DocumentEngine.ACTION_Discount;
//				options[index++] = DocumentEngine.ACTION_Receivables;
//				options[index++] = DocumentEngine.ACTION_Protested;
//				options[index++] = DocumentEngine.ACTION_Restore;
//			}
//			else if (DocStatus.equals(DocumentEngine.ACTION_Discount))
//			{
//				options[index++] = DocumentEngine.ACTION_Warranty;
//				options[index++] = DocumentEngine.ACTION_Receivables;
//				options[index++] = DocumentEngine.ACTION_Protested;
//				options[index++] = DocumentEngine.ACTION_Restore;
//			}
//			else if (DocStatus.equals(DocumentEngine.ACTION_Receivables))
//			{
//				options[index++] = DocumentEngine.ACTION_Warranty;
//				options[index++] = DocumentEngine.ACTION_Discount;
//				options[index++] = DocumentEngine.ACTION_Protested;
...
//			}			
//			else if (DocStatus.equals(DocumentEngine.ACTION_Warranty) ||
//				DocStatus.equals(DocumentEngine.ACTION_Discount) ||
//				DocStatus.equals(DocumentEngine.ACTION_Receivables))
//			{
//				options[index++] = DocumentEngine.ACTION_Protested;
//			}
//		}
//		
//		else if (m_AD_Table_ID == MRetention.Table_ID)
//		{
//			if (DocStatus.equals(DocumentEngine.STATUS_Drafted))
//				options[index++] = DocumentEngine.ACTION_ToCollect;
//			else if (DocStatus.equals(DocumentEngine.STATUS_ToCollect))
...
//		}
	...
	private boolean save()
	{
		...
		m_mTab.setValue("StatusDate", (Timestamp)fDate.getValue());
		return true;
	}	//	save
