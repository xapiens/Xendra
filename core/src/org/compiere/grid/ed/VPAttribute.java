 ...
 *
 *  @author Jorg Janke
 *  @version $Id: VPAttribute.java 3821 2011-12-15 23:22:17Z xapiens $
 */
	...
	implements VEditor, ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		boolean productWindow = m_AD_Column_ID == Util.getColumnID(X_M_Product.Table_ID, "M_AttributeSetInstance_ID");
		...
		**/
		...
		if (changed)
		{
			...
			try
			{
				fireVetoableChange(getName(), new Object(), getValue());
			}
