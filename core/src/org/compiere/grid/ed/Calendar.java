 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: Calendar.java 865 2008-03-20 00:23:42Z el_man $
 */
	...
	implements ActionListener, MouseListener, ChangeListener, KeyListener
{
	...
	private JLabel createWeekday (String title)
	{
		...
		label.setBackground(XendraPLAF.getPrimary1());
	...
	//	log.config( "Calendar.setCalendar");
		...
		for (int i = 0; i < m_days.length-2; i++)
		{
			...
			else
			{
				...
				m_days[i].setBackground(XendraPLAF.getFieldBackground_Inactive());
			}
		}
