 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: VDate.java 4685 2013-02-08 06:28:26Z xapiens $
 */
	...
	implements VEditor, ActionListener, KeyListener, FocusListener
{
	...
	{
		if (error)
			m_text.setBackground(XendraPLAF.getFieldBackground_Error());
		else if (!m_readWrite)
			m_text.setBackground(XendraPLAF.getFieldBackground_Inactive());
		else if (m_mandatory)
			m_text.setBackground(XendraPLAF.getFieldBackground_Mandatory());
		else
			m_text.setBackground(XendraPLAF.getFieldBackground_Normal());
	}	//	setBackground
