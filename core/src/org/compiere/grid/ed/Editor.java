 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: Editor.java 865 2008-03-20 00:23:42Z el_man $
 */
	...
	implements ChangeListener, ActionListener, KeyListener
{
	...
	public Editor(Frame frame, String header, String text, boolean editable, int maxSize)
	{
		...
		if (editable)
			textArea.setBackground(XendraPLAF.getFieldBackground_Normal());
		else
			textArea.setBackground(XendraPLAF.getFieldBackground_Inactive());
		textPane.setBackground(XendraPLAF.getFieldBackground_Inactive());
		updateStatusBar();
	}	//	Editor
