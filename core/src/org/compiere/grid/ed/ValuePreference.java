 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: ValuePreference.java 4091 2012-04-10 20:33:02Z xapiens $
 */
	...
	implements ActionListener
{
	...
	/** The Menu Icon               */
	private static Icon             s_icon = new ImageIcon(org.compiere.Xendra.class.getResource("images/VPreference16.gif"));
	/**	Logger			*/
	...
	//	cbClient.addActionListener(this);
		...
		//	Can Change Org
		if (REF_AD_RolePreferenceType.Client.equals(m_role.getPreferenceType()))
		...
		//	Can Change User
		if (REF_AD_RolePreferenceType.Client.equals(m_role.getPreferenceType())
			|| REF_AD_RolePreferenceType.Organization.equals(m_role.getPreferenceType()))
	...
	public void insert()
	{
		...
		sql.append(AD_Preference_ID).append(",").append(Client_ID).append(",").append(Org_ID)
			.append(", 'Y',CURRENT_TIMESTAMP,").append(m_AD_User_ID).append(",CURRENT_TIMESTAMP,").append(m_AD_User_ID).append(", ");
		if (cbWindow.isSelected())
