 ...
 *  </pre>
 * @author  Jorg Janke
 * @version $Id: GridController.java 1984 2010-11-12 03:38:10Z xapiens $
 *
		...
		VetoableChangeListener,	PropertyChangeListener, MouseListener
{
	...
	public boolean initGrid (GridTab mTab, boolean onlyMultiRow, int WindowNo, GridPanel aPanel, GridWindow mWindow, boolean lazy)
	{
		...
		vPanel.putClientProperty(XendraLookAndFeel.HIDE_IF_ONE_TAB, Boolean.TRUE);
		if (this.isDetailGrid())
		{
			vPanel.setBorder(BorderFactory.createLineBorder(XendraPLAF.getPrimary2()));
		}
