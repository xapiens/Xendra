...
import org.compiere.model.persistence.X_M_RMA;
...
public class VCreateFromFactory
{
	...
	static
	{
		...
		s_registeredClasses.put(X_C_Invoice.Table_ID, VCreateFromInvoiceUI.class);
		
		s_registeredClasses.put(X_C_BankStatement.Table_ID, VCreateFromStatementUI.class);
		s_registeredClasses.put(X_M_InOut.Table_ID, VCreateFromShipmentUI.class);
		s_registeredClasses.put(X_M_RMA.Table_ID, VCreateFromRMAUI.class);
	}
