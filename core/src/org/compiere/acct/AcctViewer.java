...
import org.xendra.apps.form.CurrencyExchangeDialog;

/**
 *  Account Viewer
 *
 *  @author Jorg Janke
 *  @version  $Id: AcctViewer.java 4862 2013-05-02 14:14:19Z xapiens $
 * 
	...
	implements ActionListener, ChangeListener
{
	...
	/** Image Icon			*/
	private ImageIcon 		m_iFind = new ImageIcon(org.compiere.Xendra.class.getResource("images/Find16.gif"));
	...
	private CComboBox selCurrency = new CComboBox();
	private CComboBox selPostingType = new CComboBox();
	private CCheckBox selDocument = new CCheckBox();
	//private CCheckBox groupByDocument = new CCheckBox();
	...
	{
		ImageIcon ii = new ImageIcon(org.compiere.Xendra.class.getResource("images/InfoAccount16.gif"));
		setIconImage(ii.getImage());
		
		popup.add(calcMenu);
		calcMenu.setText(Msg.getMsg(Env.getCtx(), "Calculator"));
		calcMenu.setIcon(new ImageIcon(org.compiere.Xendra.class.getResource("images/Calculator16.gif")));
		calcMenu.addActionListener(this);
		popup.add(zoomMenu);
		zoomMenu.setText(Msg.getMsg(Env.getCtx(), "Zoom"));
		zoomMenu.setIcon(new ImageIcon(org.compiere.Xendra.class.getResource("images/Zoom16.gif")));
		...
		lCurrency.setLabelFor(selCurrency);
		...
		//groupByDocument.setText(Msg.getMsg(Env.getCtx(), "GroupByDocument"));
		//groupByDocument.addActionListener(this);
		summary.setText(Msg.getMsg(Env.getCtx(), "GroupBy"));
		...
		//selectionPanel.add(groupByDocument,        new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
		//		,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 5, 10, 5), 0, 0));
		selectionPanel.add(summary, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 5, 10, 5), 0, 0));

		selectionPanel.add(lpostingType,  new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(selPostingType,new GridBagConstraints(1, 3, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lDate,         new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(selDateFrom,   new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(selDateTo,     new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lCurrency,     new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 0, 0, 5), 0, 0));
		selectionPanel.add(selCurrency,   new GridBagConstraints(1, 5, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lOrg,          new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 0, 0, 5), 0, 0));
		selectionPanel.add(selOrg,        new GridBagConstraints(1, 6, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));		
		selectionPanel.add(lAcct,         new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(selAcct,       new GridBagConstraints(1, 7, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel1,         new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel2,         new GridBagConstraints(0, 9, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel3,         new GridBagConstraints(0,10, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel1,          new GridBagConstraints(1, 8, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel2,          new GridBagConstraints(1, 9, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel3,          new GridBagConstraints(1, 10, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel4,         new GridBagConstraints(0, 11, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel4,          new GridBagConstraints(1, 11, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));

		selectionPanel.add(lsel5, new GridBagConstraints(0, 12, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel5,  new GridBagConstraints(1, 12, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel6, new GridBagConstraints(0, 13, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel6,  new GridBagConstraints(1, 13, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel7, new GridBagConstraints(0, 14, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel7,  new GridBagConstraints(1, 14, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(lsel8, new GridBagConstraints(0, 15, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		selectionPanel.add(sel8,  new GridBagConstraints(1, 15, 2, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));		
		//
	...
	private void dynInit (int AD_Table_ID, int Record_ID)
	{
		...
		m_data.fillCurrency(selCurrency);
	...
	//	log.info(e.getActionCommand());
		...
		if (source == selAcctSchema)
			...
			exportExcel();
		else if (source == calcMenu)
		{
			BigDecimal number = null;
			Object data = table.getValueAt(this.table.getSelectedRow(), this.table.getSelectedColumn());
			try
			{
				if (data != null)
				{
		...
		else if (source == zoomMenu)
		{
			Boolean IsSOTrx = true;
			Integer Record_ID   = (Integer) table.getValueAt(this.table.getSelectedRow(), 
					table.getRModel().getColumnIndex("Record_ID") );
			KeyNamePair knp = (KeyNamePair) table.getValueAt(this.table.getSelectedRow(), 
					table.getRModel().getColumnIndex("AD_Table_ID") );
			KeyNamePair C_DocType_ID   = (KeyNamePair) table.getValueAt(this.table.getSelectedRow(), 
					table.getRModel().getColumnIndex("C_DocType_ID") );
			if (C_DocType_ID.getKey() > 0)
			{
				MDocType dt = MDocType.get(Env.getCtx(), C_DocType_ID.getKey());
				if (dt != null)
					IsSOTrx = dt.isSOTrx();
			}
			if ( knp != null )
			{
				Integer AD_Table_ID = knp.getKey();
				MTable table = MTable.get(Env.getCtx(), AD_Table_ID);
				MQuery query = new MQuery(table.getTableName());
				String tablePK = table.getKeyColumns()[0];
				
				query.addRestriction(tablePK, MQuery.EQUAL, Record_ID);			
				setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
				AWindow frame = new AWindow();
				int AD_Window_ID = IsSOTrx ? table.getAD_Window_ID() : table.getPO_Window_ID();
				if (AD_Window_ID == 0)
				{
					String SOTrx = IsSOTrx ? String.valueOf('Y'):String.valueOf('N');
					AD_Window_ID = DB.getSQLValue(null,  " SELECT  t.AD_Window_ID FROM AD_Tab t JOIN AD_Window w on t.AD_Window_ID = w.AD_Window_ID AND w.IsSOTrx = ? WHERE t.AD_Table_ID = ? AND w.WindowType = 'T'", SOTrx ,AD_Table_ID);
					if (AD_Window_ID < 0)
					{
						SOTrx = IsSOTrx ? String.valueOf('N'):String.valueOf('Y');
						AD_Window_ID = DB.getSQLValue(null,  " SELECT  t.AD_Window_ID FROM AD_Tab t JOIN AD_Window w on t.AD_Window_ID = w.AD_Window_ID AND w.IsSOTrx = ? WHERE t.AD_Table_ID = ? AND w.WindowType = 'T'", SOTrx ,AD_Table_ID);
					}
				}
				if (AD_Window_ID > 0)
	...
	private void actionAcctSchema()
	{
		...
		for (int i = 0; i < elements.length && selectionIndex < labels.length; i++)
		{
			...
			//  Additional Elements
			if (!ase.isElementType(REF_C_AcctSchemaElementType.Organization) 
				&& !ase.isElementType(REF_C_AcctSchemaElementType.Account))
			{
	...
	private void actionQuery()
	{
		...
		//m_data.setgroupByDocument(groupByDocument.isSelected());
		m_data.setsummary(summary.isSelected());
		Integer C_Currency_ID = Integer.valueOf(((KeyNamePair)selCurrency.getSelectedItem()).getID());
		m_data.setsourceC_Currency_ID(C_Currency_ID);
	...
	private int actionButton(CButton button)
	{
		...
		if (keyColumn.equals("Account_ID"))
		{
			...
			MAcctSchemaElement ase = m_data.ASchema
				.getAcctSchemaElement(REF_C_AcctSchemaElementType.Account);
			if (ase != null)
		...
		else if (keyColumn.equals("User1_ID"))
		{
			lookupColumn = "C_ElementValue_ID";
			MAcctSchemaElement ase = m_data.ASchema
				.getAcctSchemaElement(REF_C_AcctSchemaElementType.UserList1);
			if (ase != null)
				whereClause += " AND C_Element_ID=" + ase.getC_Element_ID();
		}
		else if (keyColumn.equals("User2_ID"))
		{
			lookupColumn = "C_ElementValue_ID";
			MAcctSchemaElement ase = m_data.ASchema
				.getAcctSchemaElement(REF_C_AcctSchemaElementType.UserList2);
			if (ase != null)
				whereClause += " AND C_Element_ID=" + ase.getC_Element_ID();
		}
	...
	private void actionRePost()
	{
			...
			&& ADialog.ask(m_data.WindowNo, this, "PostImmediate?"))
		{
			...
			if (error != null)
			{
				if (Env.getContext(Env.getCtx(), "#RateException").compareTo("Y") == 0)
				{
					int From = Env.getContextAsInt(Env.getCtx(), "#RateCurrency_ID");
					int To   = Env.getContextAsInt(Env.getCtx(), "#RateCurrencyTo_ID");
					int Conversiontype = Env.getContextAsInt(Env.getCtx(), "#RateConversionType_ID");
					if (From > 0 && To > 0 && Conversiontype > 0)
					{
						CurrencyExchangeDialog cedialog = new CurrencyExchangeDialog(null, 
								Env.getContextAsInt(Env.getCtx(), "#RateCurrency_ID"), 
								Env.getContextAsInt(Env.getCtx(), "#RateCurrencyTo_ID") , 
								Env.getContextAsInt(Env.getCtx(), "#RateConversionType_ID"), 
								Env.getContextAsDate(Env.getCtx(), "#RateDateDoc"), 
								Ini.isPropertyBool(Ini.P_SHOW_ACCT));
						if (cedialog.isOK())
						{
							error = AEnv.postImmediate (m_data.WindowNo, Env.getAD_Client_ID(Env.getCtx()),
									m_data.AD_Table_ID, m_data.Record_ID, force);								
						}	
					}
					Env.setContext(Env.getCtx(), "#RateException", "");
					Env.setContext(Env.getCtx(), "#RateCurrency_ID", ""); 
					Env.setContext(Env.getCtx(), "#RateCurrencyTo_ID", ""); 
					Env.setContext(Env.getCtx(), "#RateConversionType_ID", ""); 
					Env.setContext(Env.getCtx(), "#RateDateDoc", ""); 							
				}
				if (error != null)
					ADialog.error(m_data.WindowNo, this, "PostingError-N", error);				
