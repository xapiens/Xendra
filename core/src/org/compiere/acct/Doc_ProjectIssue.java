 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: Doc_ProjectIssue.java,v 1.1 2007/06/15 00:03:25 sergioaguayo Exp $
 */
public class Doc_ProjectIssue extends Doc
{
	...
	{
		super (ass, MProjectIssue.class, rs, REF_C_DocTypeDocBaseType.ProjectIssue, trxName);
	}   //  Doc_ProjectIssue
	...
	public ArrayList<Fact> createFacts (MAcctSchema as)
	{
		...
		MProduct product = MProduct.get(getCtx(), m_issue.getM_Product_ID(), null);
		...
		{
			cost = ce.getCostForProduct(getAD_Client_ID(),
					getAD_Org_ID(), 
					m_line.getProduct().get_ID(), 
					getDateAcct(), false,	false,false, null);			
		}
		...
		if (REF_C_ProjectTypeCategory.AssetProject.equals(ProjectCategory))
	...
	private BigDecimal getPOCost(MAcctSchema as)
	{
		...
		//	Uses PO Date
		String sql = "SELECT currencyConvert(ol.PriceActual,0, o.C_Currency_ID, ?, o.DateOrdered, o.C_ConversionType_ID, ?, ?) "
			+ "FROM C_OrderLine ol"
