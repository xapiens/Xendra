 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: DocLine.java,v 1.1 2007/06/15 00:03:24 sergioaguayo Exp $
 */
...
{	
	...
	/** Asset                       */
	private int                 m_AD_Asset_ID = -1;
	/** Invoice Advance */
	private int 				m_C_InvoiceAdvance_ID = -1;

	public int getAD_Asset_ID()
	{
		return m_AD_Asset_ID;			
	}
	
	public void setAD_Asset_ID(Integer p_AD_Asset_ID)
	{
		if (p_AD_Asset_ID != null)
			m_AD_Asset_ID = p_AD_Asset_ID;
	}
	/**
	 *  Get Currency
	...
	public boolean isItem()
	{
		...
		{
			MProduct product = MProduct.get(Env.getCtx(), getM_Product_ID(), null);
	...
	{
		m_C_InvoiceAdvance_ID = C_InvoiceAdvance_ID;
	}
	
	public int getC_InvoiceAdvance_ID()
	{
		return m_C_InvoiceAdvance_ID;
	}	
	/**
	 *  Get Production Plan
...
//	{
//		Boolean ii = p_po.get_ValueAsBoolean("IsCosted");
//		return ii;
//	}   //  getC_OrderLine_ID
	 ...
	 *  @return costs
	 */
//	public BigDecimal getProductCosts (MAcctSchema as, int AD_Org_ID, boolean zeroCostsOK, Timestamp DateAcct)
//	{
//		ProductCost pc = getProductCost();
//		int C_OrderLine_ID = getC_OrderLine_ID();
//		String costingMethod = null;
//		BigDecimal costs = pc.getProductCosts(as, AD_Org_ID, costingMethod, 
//			C_OrderLine_ID, zeroCostsOK, DateAcct);
//		if (costs != null)
//			return costs;
//		return Env.ZERO;
//	}   //  getProductCosts
	...
	{
		if (m_productCost == null)
			m_productCost = new ProductCost (Env.getCtx(), getM_Product_ID(), getM_AttributeSetInstance_ID(), p_po.get_TrxName());
		if (m_productCost != null)
