 ...
 * 
 * @author Jorg Janke
 * @version $Id: Doc_Requisition.java,v 1.1 2007/06/15 00:03:25 sergioaguayo Exp $
 */
public class Doc_Requisition extends Doc
{
	...
	{
		super (ass, MRequisition.class, rs, REF_C_DocTypeDocBaseType.PurchaseRequisition, trxName);
	}	//	Doc_Requisition
