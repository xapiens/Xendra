 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: Matcher.java,v 1.1 2007/06/15 00:03:24 sergioaguayo Exp $
 */
public class Matcher
{
	...
	//	MMatchInv inv = new MMatchInv ();
		...
		StringBuffer sql = new StringBuffer("INSERT INTO M_MatchInv ("
			...
			.append(AD_Client_ID).append(",").append(AD_Org_ID).append(",'Y',CURRENT_TIMESTAMP,0,CURRENT_TIMESTAMP,0, ")
