 ...
 *  </pre>
 *  @author Jorg Janke
 *  @version  $Id: Doc_Order.java,v 1.2 2007/06/22 19:01:34 sergioaguayo Exp $
 */
public class Doc_Order extends Doc
{
	...
	private DocLine[] loadLines(MOrder order)
	{
		...
		for (int i = 0; i < lines.length; i++)
		{
			...
			if (getDocumentType().equals(REF_C_DocTypeDocBaseType.PurchaseOrder))	//	PO
	...
	public BigDecimal getBalance()
	{
		...
		if (retValue.signum() != 0		//	Sum of Cost(vs. Price) in lines may not add up 
			&& getDocumentType().equals(REF_C_DocTypeDocBaseType.PurchaseOrder))	//	PO
		{
	...
	public ArrayList<Fact> createFacts (MAcctSchema as)
	{
		...
		//  Purchase Order
		if (getDocumentType().equals(REF_C_DocTypeDocBaseType.PurchaseOrder))
		{
			updateProductPO(as);
	...
	private void updateProductPO(MAcctSchema as)
	{
		...
		StringBuffer sql = new StringBuffer (
			...
			+ "SET PriceLastPO = (SELECT currencyConvert(ol.PriceActual,0,ol.C_Currency_ID,po.C_Currency_ID,o.DateOrdered,o.C_ConversionType_ID,o.AD_Client_ID,o.AD_Org_ID) "
	...
	private void updateProductInfo (int C_AcctSchema_ID)
	{
		...
		StringBuffer sql = new StringBuffer (
			...
			+ "SET PriceLastPO = "
			+ "(SELECT currencyConvert(ol.PriceActual,0,ol.C_Currency_ID,a.C_Currency_ID,o.DateOrdered,o.C_ConversionType_ID,o.AD_Client_ID,o.AD_Org_ID) "
