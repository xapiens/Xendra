 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: InventoryCountUpdate.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="M_Inventory Update ",
name="Update Quantity",
description="The Book Quantity is updated with current book quantity",
help="The Update Quantity Process will update the book quantity with the current book quantity.  ",
Identifier="dfc468db-3bac-af08-daa4-52d2df1b03da",
classname="org.compiere.process.InventoryCountUpdate",
...
public class InventoryCountUpdate extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Set Inventory Count to",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="f1afc36f-a5e8-d106-6889-baab5b054888")	
