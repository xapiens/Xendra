 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: BOMValidate.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="M_Product_BOMs",
name="Verify BOMs",
description="Verify BOM Structures",
help="The Verify BOM Structures checks the elements and steps which comprise a Bill of Materials.",
Identifier="768dac14-6023-110b-d6cf-0da120360b8c",
classname="org.compiere.process.BOMValidate",
...
public class BOMValidate extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Product Category",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="290f13f0-2ece-f2b0-0afc-f174e6fec04d")	
	private int		p_M_Product_Category_ID = 0;
	/** Re-Validate			*/
	@XendraProcessParameter(Name="Re-Validate",
	                        ColumnName="IsReValidate",
			                Description="Re-Validate entries",
			                Help="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="3791dcd8-2770-57ee-b738-323595f2d6b3")	
