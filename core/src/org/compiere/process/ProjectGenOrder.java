 ...
 *
 *	@author Jorg Janke
 *	@version $Id: ProjectGenOrder.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="C_Project_Generate",
name="Generate Order",
description="Generate Order from Project",
help="The Generate Order process will generate a new Order document based on the project phase. A price list and warehouse/service point must be defined on the project.",
Identifier="d8c6a6d2-e3fa-4cf0-89f6-a0b0e962f149",
classname="org.compiere.process.ProjectGenOrder",
...
public class ProjectGenOrder extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//	Service Project	
		if (REF_C_ProjectTypeCategory.ServiceChargeProject.equals(fromProject.getProjectCategory()))
		{
