 ...
 *	@version $Id: ImportBankStatement.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="Import_BankStatement",
...
Identifier="18af8124-ca9e-bd93-12da-ba4ce85cd49d",
classname="org.compiere.process.ImportBankStatement",
...
public class ImportBankStatement extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Client",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="6e53927f-e2fb-7cf2-6575-8548c7a9d4ae")	
	...
	@XendraProcessParameter(Name="Organization",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="9daba1e1-c5a4-f9ee-fb19-46187d05b012")	
	...
	@XendraProcessParameter(Name="Bank Account",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="4fee4c6a-b0ce-1497-0bdf-d8dc1bf51c72")	
	...
	@XendraProcessParameter(Name="Delete old imported records",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="5b70f882-8a02-ed46-5d5e-49b6e1a66f33")
