...
import org.compiere.model.persistence.X_I_Invoice;
 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: ImportInvoice.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="Import_Invoice",
name="Import Invoice",
...
Identifier="dc683745-d469-dbed-8820-63e4dc2084cb",
classname="org.compiere.process.ImportInvoice",
...
public class ImportInvoice extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Client",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="eca5dd7b-fe53-2ed8-1098-f29a0625903d")	
...
@XendraProcessParameter(Name="Organization",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="6ca4d75b-8474-66cf-8f19-9353492aa569")
...
@XendraProcessParameter(Name="Delete old imported records",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="cad6e52d-6026-f3ee-2b44-4856d0e5226d")
	...
	@XendraProcessParameter(Name="Document Action",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="07fc0572-8bba-c5cd-815b-1980203bbb15")	
		...
		try
		{
			...
			while (rs.next ())
			{
					...
					|| !oldDocumentNo.equals(cmpDocumentNo)	)
				{
					...
					invoice.setSerial(imp.getSerial());
