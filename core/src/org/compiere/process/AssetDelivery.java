 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: AssetDelivery.java 5583 2015-08-05 14:11:58Z xapiens $
 * 	@author 	Michael Judd BF [ 2736995 ] - toURL() in java.io.File has been deprecated
 */
@XendraProcess(value="Asset_Delivery",
name="Deliver Assets",
description="Deliver Customer Assets electronically",
help="Send Mail to customers and attach new delivery (optional).",
Identifier="1eb3ce2e-d5bb-fc8a-af59-0842450aaaf6",
classname="org.compiere.process.AssetDelivery",
updated="2015-06-20 10:10:12")	
public class AssetDelivery extends SvrProcess
{
	private MClient		m_client = null;
	@XendraProcessParameter(Name="Asset Group",
		                    ColumnName="A_Asset_Group_ID",
		                    Description="Group of Assets",
		                    Help="The group of assets determines default accounts.  If an asset group is selected in the product category, assets are CREATED when delivering the asset.",
		                    ...
		                    DisplayLogic="",
		                    ReadOnlyLogic="",
		                    Identifier="e8709b7c-6a29-03da-ec26-12d18f100099")			
	...
	@XendraProcessParameter(Name="Product",
	                        ...
	                        DisplayLogic="",
	                        ReadOnlyLogic="",
	                        Identifier="49646c1f-88c4-19e5-816f-ed5e636c1e35")				
	...
	@XendraProcessParameter(Name="Business Partner ",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="a6e99c6d-8f08-7c17-4b40-538b6f034cef")	
	private int			m_C_BPartner_ID = 0;
	@XendraProcessParameter(Name="Asset",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="33c248b5-2d4c-a702-e11e-b2bcf2d21dfd")	
	private int			m_A_Asset_ID = 0;
	@XendraProcessParameter(Name="Guarantee Date",
			                ColumnName="GuaranteeDate",
			                Description="Date when guarantee expires",
			                Help="Date when the normal guarantee or availability expires",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="64e6787e-509c-2372-1e57-6a91e1911051")	
	private Timestamp	m_GuaranteeDate = null;
	@XendraProcessParameter(Name="Expired Guarantee Mail",
			                ColumnName="NoGuarantee_MailText_ID",
			                Description="Send email to partners with expired guarantee",
			                Help="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="af547c1d-b3bd-187f-d5f5-3a9c833def4f")	
	private int	m_NoGuarantee_MailText_ID = 0;
	@XendraProcessParameter(Name="Attach Asset",
			                ColumnName="AttachAsset",
			                Description="Attach Asset to be delivered per email",
			                Help="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="cd4875da-f3f0-479a-ea35-1c5135f3a097")	
