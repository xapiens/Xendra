 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: DunningRunCreate.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="C_DunningRun_Create",
name="Create Dunning Run",
description="Create Dunning Run Entries based on the Dunning Level criteria",
help="",
Identifier="cc35db48-170a-80b4-3d52-c9c89edc477f",
classname="org.compiere.process.DunningRunCreate",
...
public class DunningRunCreate extends SvrProcess
{
	@XendraProcessParameter(Name="Include Disputed",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="4dd2965d-c85f-4cdf-426b-c512ecb9dd37")			
	private boolean 	p_IncludeInDispute = false;
	@XendraProcessParameter(Name="Only Sales Invoices",
			                ColumnName="OnlySOTrx",
			                Description="Otherwise also Payments and AP Invoices",
			                Help="",
			                AD_Reference_ID=DisplayType.YesNo,
			                SeqNo=20,
			                ReferenceValueID="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="03221076-5685-e73b-bdfe-152914dba34b")	
	private boolean		p_OnlySOTrx = false;
	@XendraProcessParameter(Name="Include All Currencies",
			                ColumnName="IsAllCurrencies",
			                Description="Report not just foreign currency Invoices",
			                Help="",
			                AD_Reference_ID=DisplayType.YesNo,
			                SeqNo=45,
			                ReferenceValueID="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="30676aa3-d1a5-658a-1d39-6bbea3122019")	
	private boolean		p_IsAllCurrencies = false;
	@XendraProcessParameter(Name="Default Sales Rep",
			                ColumnName="SalesRep_ID",
			                Description="If not defined on Business Partner Level",
			                Help="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="f9203eb2-e4b7-8897-82e0-200c4766dc54")	
	private int			p_SalesRep_ID = 0;
	@XendraProcessParameter(Name="Dunning Currency",
			                ColumnName="C_Currency_ID",
			                Description="Currency to create Dunning Letters",
			                Help="",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="ae41efbb-d7e3-65b3-ea3a-fc60d26b63df")	
	...
	@XendraProcessParameter(Name="Business Partner ",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="5202861f-952f-874d-c35e-a9939f8f712d")	
	...
	@XendraProcessParameter(Name="Business Partner Group",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="046b21f3-18d2-e8b8-01e0-3767601243af")	
	...
	//	log.info(sql);
		...
		sql2 = "SELECT COUNT(*), COALESCE(TRUNC(CURRENT_TIMESTAMP-MAX(dr.DunningDate)),0) "
