 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: XendraServer.java 1109 2009-12-24 13:41:29Z xapiens $
 */
public abstract class XendraServer extends Thread
{
	/**
	 * 	XendraServer
	 *	@param name server name
	 */
	public XendraServer (String name)
	{
		super (s_threadGroup, name);
	}	//	XendraServer

	/**	Thread Group			*/
	private static ThreadGroup	s_threadGroup = new ThreadGroup("XendraServer");
	...
	{
		StringBuffer sb = new StringBuffer ("XendraServer[");
