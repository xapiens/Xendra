 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: ImportReportLine.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="Import_ReportLine",
name="Import Report Line Set",
description="Import Report Line Set information",
help="The Parameters are default values for null import record values, they do not overwrite any data.",
Identifier="44600fbb-7d13-03ff-277e-249bb341e799",
classname="org.compiere.process.ImportReportLine",
...
public class ImportReportLine extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Client",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="8f28da99-5c98-6fef-4926-603042dc0860")	
...
@XendraProcessParameter(Name="Report Line Set",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="a5f927a2-c050-bd73-0ed3-a690349c9703")
...
@XendraProcessParameter(Name="Delete old imported records",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="33b57401-d3cc-1287-c5a3-9f440732c216")
	...
	protected String doIt() throws java.lang.Exception
	{
		...
		sql = new StringBuffer ("UPDATE PA_ReportLine r "
			...
			+ " (SELECT Description,SeqNo,IsSummary,IsPrinted,LineType,CalculationType,AmountType,PostingType,CURRENT_TIMESTAMP,UpdatedBy"
		...
		try
		{
			...
			String sqlt="UPDATE PA_ReportSource "
				...
				+ " (SELECT 'AC',C_ElementValue_ID,CURRENT_TIMESTAMP,UpdatedBy"
				+ " FROM I_ReportLine"
				+ " WHERE I_ReportLine_ID=?) "
			...
			PreparedStatement pstmt_setImported = DB.prepareStatement
				...
				+ " PA_ReportSource_ID=?, "
				+ " Updated=CURRENT_TIMESTAMP, Processed='Y' WHERE I_ReportLine_ID=?", get_TrxName());
			...
			while (rs.next())
			{
				...
				else								//	update Report Source
				{
					...
					String sqlt="UPDATE PA_ReportSource "
						+ "SET (ElementType,C_ElementValue_ID,Updated,UpdatedBy)="
						+ " (SELECT CAST('AC' AS CHAR(2)),C_ElementValue_ID,CURRENT_TIMESTAMP,UpdatedBy"  //jz
						+ " FROM I_ReportLine"
