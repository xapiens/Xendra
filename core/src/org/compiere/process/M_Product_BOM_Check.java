 ...
 *  @version $Id: M_Product_BOM_Check.java 5583 2015-08-05 14:11:58Z xapiens $
 * @author Carlos Ruiz (globalqss)
 *         Make T_Selection tables permanent         
 */
@XendraProcess(value="M_Product_BOM",
name="Verify BOM",
description="Verify BOM Structure",
help="The Verify BOM Structure checks the elements and steps which comprise a Bill of Materials.",
Identifier="d551caf4-4ce8-9c21-490e-764e98942f42",
classname="org.compiere.process.M_Product_BOM_Check",
