 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: DocumentTypeVerify.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="C_DocumentType Verify",
name="Verify Document Types",
description="Verify Document Types and Period Controls",
help="Makes sure that there is a DocumentType for all Document Base Types<br>Creates missing Period Controls for Document Type (You may have to open them)",
Identifier="35a13223-de9b-ac42-12c6-9c7a1dc2ca31",
