...
/**
 *	Xendra Service.
 *	Instanciates and Controls the Xendra Server, 
 *	which actually does the work in separate thread
 *	
 *  @author Jorg Janke
 *  @version $Id: XendraService.java 1109 2009-12-24 13:41:29Z xapiens $
 */
public class XendraService extends StateEngine
{
	/**
	 * 	Xendra Service
	 ...
	 */
	public XendraService (PO processor, Class serverClass)
	{
		super ();
	...
	/**	Adempiere Server(s)			*/
	private XendraServer	m_server = null;
	 ...
	 */
	public XendraServer getCompierServer()
	{
		getState();
		return m_server;
	}	//	getXendraServer
	...
	public boolean start()
	{
		...
		try
		{
			m_server = (XendraServer)m_serverClass.newInstance();
