...
import org.compiere.model.persistence.X_I_Payment;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: ImportPayment.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="Import_Payment",
...
Identifier="427aa321-2d6a-6858-0f2a-5d25be9b95fc",
classname="org.compiere.process.ImportPayment",
...
public class ImportPayment extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Organization",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="b1092b5b-451d-d31a-8500-91a07432cd5a")	
	...
	@XendraProcessParameter(Name="Bank Account",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="dc6dde37-ddf4-1f23-5835-00169cadf0b6")	
...
@XendraProcessParameter(Name="Delete old imported records",
                ...
                DisplayLogic="",
                ReadOnlyLogic="",
                Identifier="e2f29117-2c76-42b1-d3e0-4df98e0d3b8d")
	...
	protected String doIt() throws Exception
	{
		...
		if (p_C_BankAccount_ID == 0 || ba.get_ID() != p_C_BankAccount_ID)
			throw new XendraUserError("@NotFound@ @C_BankAccount_ID@ - " + p_C_BankAccount_ID);
