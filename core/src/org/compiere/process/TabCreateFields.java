 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: TabCreateFields.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="AD_Tab_CreateFields",
name="Create Fields",
description="Create Field from Table Column, which do not exist in the Tab yet",
help="Based on the table columns of this Tab, this procedure creates the missing Fields",
Identifier="aa07b771-26a1-2115-5a8c-2761edd6e6cf",
classname="org.compiere.process.TabCreateFields",
...
public class TabCreateFields extends SvrProcess
{
	...
	public String doIt () throws Exception
	{
		...
		if (p_AD_Tab_ID == 0 || tab == null || tab.get_ID() == 0)
			throw new XendraSystemError("@NotFound@: @AD_Tab_ID@ " + p_AD_Tab_ID);
