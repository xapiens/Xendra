 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: TreeMaintenance.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="AD_Tree Verify",
name="Verify Tree",
description="Verify completeness and correctness of Tree",
help="",
Identifier="321d429e-3a54-bbac-425b-2f8b9650657f",
classname="org.compiere.process.TreeMaintenance",
...
public class TreeMaintenance extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//
		if (REF_AD_TreeTypeType.BoM.equals(tree.getTreeType()))
	...
	private String verifyTree (MTree_Base tree)
	{
		...
		int C_Element_ID = 0;
		if (REF_AD_TreeTypeType.ElementValue.equals(tree.getTreeType()))
		{
