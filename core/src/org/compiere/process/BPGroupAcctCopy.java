 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: BPGroupAcctCopy.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="C_BP_Group_Acct_Copy",
name="Copy Accounts",
description="Copy and overwrite Accounts to Business Partners of this group",
help="If you copy and overwrite the current default values, you may have to repeat previous updates (e.g. set the receivebles account, ...)",
Identifier="4fbbacc8-b7c7-8cc5-5eaf-f976b4f61f5a",
classname="org.compiere.process.C_BP_Group_Acct_Copy",
...
public class BPGroupAcctCopy extends SvrProcess
{
	...
	@XendraProcessParameter(Name="Business Partner Group",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="40d4a19d-8cd3-ac22-89a1-1bc77fa530d1")	
	...
	@XendraProcessParameter(Name="Accounting Schema",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="fb6f6824-a05e-f176-64e8-1dff0b7ebde2")	
