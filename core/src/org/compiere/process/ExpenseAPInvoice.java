 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: ExpenseAPInvoice.java 5583 2015-08-05 14:11:58Z xapiens $
 */
@XendraProcess(value="S_ExpenseAPInvoice",
name="Create AP Expense Invoices",
description="Create AP Invoices from Expenses to be paid to employees",
help="",
Identifier="e28a1557-0ee7-920a-17c0-8b210d0ad779",
...
public class ExpenseAPInvoice extends SvrProcess
{
	@XendraProcessParameter(Name="Business Partner ",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="dc19a8e4-bb39-4277-9c68-22cd8cdf6baf")	
	private int			m_C_BPartner_ID = 0;
	@XendraProcessParameter(Name="Report Date",
			                ColumnName="DateReport",
			                Description="Expense/Time Report Date",
			                Help="Date of Expense/Time Report",
			                ...
			                DisplayLogic="",
			                ReadOnlyLogic="",
			                Identifier="dbe263b6-43ff-f1f6-9920-cbe29efd7d17")	
