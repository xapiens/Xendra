 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: CField.java,v 1.1 2007/06/14 23:44:25 sergioaguayo Exp $
 */
...
//			setEditor (editor);
	...
	public void setBackground (boolean error)
	{
		Color bg = null;
		if (error)
			bg = XendraPLAF.getFieldBackground_Error();
		else if (!isReadWrite())
			bg = XendraPLAF.getFieldBackground_Inactive();
		else if (m_mandatory)
			bg = XendraPLAF.getFieldBackground_Mandatory();
		else
			bg = XendraPLAF.getFieldBackground_Normal();
