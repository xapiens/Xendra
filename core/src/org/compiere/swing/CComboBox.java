...
/**
 *  Xendra Colored Combo Box.
 *
 *  @author     Jorg Janke
 *  @version    $Id: CComboBox.java,v 1.1 2007/06/14 23:44:24 sergioaguayo Exp $
 */
	...
	implements CEditor
{
	...
	/**
	 *  Display Popup.
	 *  Called from XendraComboPopup and allows to implement
	...
	public void addMouseListener (MouseListener ml)
	{
		...
		if (getUI() instanceof CompiereComboBoxUI && !Trace.getCallerClass(1).startsWith("javax"))
		{
			...
			if (b != null)
                ...
                if (getUI() instanceof org.xendra.plaf.XendraComboBoxUI && !Trace.getCallerClass(1).startsWith("javax"))
		{
			JButton b = ((org.xendra.plaf.XendraComboBoxUI)getUI()).getArrowButton();
			if (b != null)
				b.addMouseListener(ml);
		}
