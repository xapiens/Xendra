...
import org.xendra.plaf.XendraLookAndFeel;
import org.xendra.plaf.XendraPLAF;
import org.compiere.plaf.*;

/**
 *  Xendra Panel supporting colored Backgrounds
 *
 *  @author     Jorg Janke
 *  @version    $Id: CPanel.java,v 1.1 2007/06/14 23:44:23 sergioaguayo Exp $
 */
public class CPanel extends JPanel
{
	/**
	 * Creates a new XendraPanel with the specified layout manager
	...
	/**
	 *  Common init.
	 *  Xendra backround requires that for the base, background is set explictily.
	...
	{
		if (level == 0)
			putClientProperty(XendraLookAndFeel.TABLEVEL, null);
		else
			putClientProperty(XendraLookAndFeel.TABLEVEL, new Integer(level));
	}   //  setTabLevel
