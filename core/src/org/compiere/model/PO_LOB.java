 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: PO_LOB.java 5497 2014-12-22 06:20:34Z xapiens $
 */
public class PO_LOB implements Serializable
{
	...
	{
		if (m_value == null
			|| (!(m_value instanceof String || m_value instanceof byte[] || m_value instanceof HashMap)) 
		...
		try
		{
			...
			else if (m_displayType == DisplayType.HStore)
				pstmt.setObject(1, m_value);
			else
