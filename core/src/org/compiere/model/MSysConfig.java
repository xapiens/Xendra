...
import org.compiere.model.persistence.X_AD_SysConfig;
 ...
 *	
 *  @author Armen Rizal
 *  @version $Id: MSysConfig.java 5583 2015-08-05 14:11:58Z xapiens $
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (getAD_Client_ID() != 0 || getAD_Org_ID() != 0) {
			...
			if (configLevel != null) {
				...
				if (getAD_Org_ID() != 0 && 
						(configLevel.equals(REF_AD_SysConfigConfigurationLevel.System) || 
						 configLevel.equals(REF_AD_SysConfigConfigurationLevel.Client))) {
				...
				if (getAD_Client_ID() != 0 && configLevel.equals(REF_AD_SysConfigConfigurationLevel.System)) {
				...
				if (getAD_Org_ID() != 0)
					setConfigurationLevel(REF_AD_SysConfigConfigurationLevel.Organization);
				else if (getAD_Client_ID() != 0 && getConfigurationLevel().equals(REF_AD_SysConfigConfigurationLevel.System))
					setConfigurationLevel(REF_AD_SysConfigConfigurationLevel.Client);
