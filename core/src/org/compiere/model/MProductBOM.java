...
import org.compiere.model.persistence.X_M_Product_BOM;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MProductBOM.java 4091 2012-04-10 20:33:02Z xapiens $
 */
public class MProductBOM extends X_M_Product_BOM
{
	...
	public MProduct getProduct()
	{
		if (m_product == null && getM_ProductBOM_ID() != 0)
			m_product = MProduct.get (getCtx(), getM_ProductBOM_ID(), get_TrxName());
		return m_product;
	}	//	getProduct
