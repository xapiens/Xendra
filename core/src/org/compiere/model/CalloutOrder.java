...
//import org.xendra.standard.Policy;

/**
 *	Order Callouts.
 *	
 *  @author Jorg Janke
 *  @version $Id: CalloutOrder.java 5822 2016-06-15 22:56:06Z xapiens $
 */
...
//						C_OrderLine_ID.intValue());
	...
	public String amt (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		if (
			...
			||
			( !Env.isSOTrx(ctx, WindowNo) && mField.getColumnName().equals("M_Product_ID") )
		)
		{
			int C_BPartner_ID = Env.getContextAsInt(ctx, WindowNo, "C_BPartner_ID");
