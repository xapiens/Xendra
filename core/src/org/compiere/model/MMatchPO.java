...
import org.compiere.model.persistence.X_M_MatchPO;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MMatchPO.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MMatchPO extends X_M_MatchPO
{
	...
	protected boolean beforeDelete ()
	{
		if (isPosted())
		{
			if (!MPeriod.isOpen(getCtx(), getDateTrx(), REF_C_DocTypeDocBaseType.MatchPO, getAD_Org_ID(), getAD_Client_ID()))
				return false;
			setPosted(false);
	...
	protected boolean afterDelete (boolean success)
	{
		...
		if (success && getC_OrderLine_ID() != 0)
		{
			...
			// TODO: Arana , no calculation costs here , cost detail reference deleted
