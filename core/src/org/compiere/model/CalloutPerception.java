 ...
 *  @version 
 */
public class CalloutPerception extends CalloutEngine
{
	...
	public String invoice (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		try
		{
			...
			if (rs.next())
			{
				...
				MRetention retention = new MRetention(Env.getCtx(), 0, null);
				//BigDecimal taxAmt = retention.calculateRetention(InvoiceOpen , C_Currency_ID);
