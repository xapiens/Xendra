...
{
set_Value (COLUMNNAME_Transactions, Integer.valueOf(Transactions));
}
/** Get Transactions.
@return Transactions */
public int getTransactions() 
{
Integer ii = (Integer)get_Value(COLUMNNAME_Transactions);
if (ii == null) return 0;
return ii.intValue();
}

@XendraTrl(Identifier="7aae07ac-101f-4325-a8c4-4b9af7d6656f")
public static String es_PE_COLUMN_Transactions_Name="transactions";

@XendraColumn(AD_Element_ID="fd6b6f02-0c16-46d6-8638-baf96ed810d1",ColumnName="Transactions",
