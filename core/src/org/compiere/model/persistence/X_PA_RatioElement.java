...
import org.compiere.model.reference.REF_PA_RatioElementType;
import org.compiere.model.reference.REF_PA_RatioOperand;
...
@XendraTab(Name="Element",Description="Performance Ratio Element",
...
@XendraTable(Name="Ratio Element",Description="Performance Ratio Element",Help="",
TableName="PA_RatioElement",AccessLevel="2",AD_Window_ID="55c355a0-9ecc-670d-480c-5315b8c95dd3",
AD_Val_Rule_ID="",IsKey=1,LoadSeq=145,IsSecurityEnabled=false,IsDeleteable=true,IsHighVolume=true,
IsChangeLog=false,IsView=false,PO_Window_ID="",ID="org.xendra.performanceanalysis",
Identifier="168b7252-2360-e82a-4f54-d4760d14693b",Synchronized="2017-08-16 11:43:41.0")
...
Identifier="2c6f0d42-7781-e47b-9077-fcf2807fbf86",Synchronized="2017-08-05 16:55:42.0")
...
IsCentrallyMaintained=true,AD_Tab_ID="04695927-0550-7881-404d-3ce482f22095",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=120,IsReadOnly=false,SeqNo=40,SortNo=0,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="6255a0b8-8de1-c819-6557-0427f05f685f")
...
/** PA_RatioUsed_ID AD_Reference=ab063eee-ccf8-4f4f-9bad-a7f0d53a14f6 */
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="a755c71e-2582-3136-df59-41059ba18a5d",Synchronized="2017-08-05 16:55:42.0")
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="d259d5a3-b01d-d5c6-0529-ca9a142fc19a",Synchronized="2017-08-05 16:55:42.0")
/** Column name PostingType */
public static final String COLUMNNAME_PostingType = "PostingType";

/** RatioElementType AD_Reference=29462fd0-b2bb-8d8c-fc51-6a41a22f028f */
...
if (RatioElementType.equals(REF_PA_RatioElementType.Ratio) || RatioElementType.equals(REF_PA_RatioElementType.Constant) || RatioElementType.equals(REF_PA_RatioElementType.Calculation) || RatioElementType.equals(REF_PA_RatioElementType.AccountValue));
 else throw new IllegalArgumentException ("RatioElementType Invalid value - " + RatioElementType + " - Reference_ID=372 - R - C - X - A");
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="26cd3ec1-e403-70da-a5d8-4e592a10a31d",Synchronized="2017-08-05 16:55:42.0")
/** Column name RatioElementType */
public static final String COLUMNNAME_RatioElementType = "RatioElementType";

/** RatioOperand AD_Reference=44176ac4-188a-6d06-e432-378b8cb10d30 */
...
if (RatioOperand.equals(REF_PA_RatioOperand.Plus) || RatioOperand.equals(REF_PA_RatioOperand.Minus) || RatioOperand.equals(REF_PA_RatioOperand.Multiply) || RatioOperand.equals(REF_PA_RatioOperand.Divide));
 else throw new IllegalArgumentException ("RatioOperand Invalid value - " + RatioOperand + " - Reference_ID=373 - P - N - M - D");
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="d96ffc75-c8ae-abc9-720e-633a51b26416",Synchronized="2017-08-05 16:55:42.0")
