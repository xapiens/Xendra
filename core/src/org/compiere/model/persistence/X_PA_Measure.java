...
@XendraTab(Name="Measure",Description="Performance Measure",
...
@XendraTable(Name="Measure",Description="Concrete Performance Measurement",Help="",
TableName="PA_Measure",AccessLevel="6",AD_Window_ID="77e27ab5-730a-939b-28f1-8469068c1e44",
...
Identifier="c3d77e15-7c74-a997-380e-9c543459faf2",Synchronized="2017-08-16 11:43:40.0")
...
@XendraField(AD_Column_ID="ManualNote",
IsCentrallyMaintained=true,AD_Tab_ID="8ac9b36b-799c-7af6-ed3f-d8d9d0210239",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="@MeasureType@=M",DisplayLength=60,IsReadOnly=false,SeqNo=90,
...
/** MeasureDataType AD_Reference=e04ce600-714c-a8a5-5a36-6390b68f39f6 */
...
if (MeasureDataType.equals(REF_PA_MeasureDataType.QtyAmountInTime) || MeasureDataType.equals(REF_PA_MeasureDataType.StatusQtyAmount));
 else throw new IllegalArgumentException ("MeasureDataType Invalid value - " + MeasureDataType + " - Reference_ID=369 - T - S");
...
Identifier="4867ba22-17a0-de6a-d046-0e9b1578fc3f",Synchronized="2017-08-05 16:55:40.0")
/** Column name MeasureDataType */
public static final String COLUMNNAME_MeasureDataType = "MeasureDataType";

/** MeasureType AD_Reference=a4edf16f-cf34-ee95-53c0-01e19e781b26 */
...
if (MeasureType.equals(REF_PA_MeasureType.Request) || MeasureType.equals(REF_PA_MeasureType.Project) || MeasureType.equals(REF_PA_MeasureType.UserDefined) || MeasureType.equals(REF_PA_MeasureType.Ratio) || MeasureType.equals(REF_PA_MeasureType.Manual) || MeasureType.equals(REF_PA_MeasureType.Calculated) || MeasureType.equals(REF_PA_MeasureType.Achievements));
 else throw new IllegalArgumentException ("MeasureType Invalid value - " + MeasureType + " - Reference_ID=231 - Q - P - U - R - M - C - A");
...
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="8705dcb6-6897-7f77-21e2-108236867a03",Synchronized="2017-08-05 16:55:40.0")
...
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="6821444a-1f88-d340-5ba1-7aa1d974dbe4")
