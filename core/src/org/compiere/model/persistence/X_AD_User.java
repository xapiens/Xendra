...
import org.compiere.model.reference.REF_AD_UserConnectionProfile;
...
@XendraTab(Name="User Contact",Description="Maintain User or Business Partner Contact",
...
public static String es_PE_TAB_ContactUser_Description="Mantenga a usuario dentro del sistema - interno ó del contacto del socio de negocio";

@XendraTrl(Identifier="cca304e4-17f2-1849-76c1-8fa0813b5951")
public static String es_PE_TAB_ContactUser_Name="Contacto (Usuario)";

@XendraTrl(Identifier="cca304e4-17f2-1849-76c1-8fa0813b5951")
public static String es_PE_TAB_ContactUser_Help="El usuario identifica a un usuario único en el sistema. Esto podía ser un usuario interno ó un contacto del socio de negocio";

@XendraTab(Name="Contact (User)",
...
public static final String TABNAME_ContactUser="cca304e4-17f2-1849-76c1-8fa0813b5951";

@XendraTrl(Identifier="acb1d5a9-2af9-ac81-e873-f228168505a3")
public static String es_PE_TABLE_AD_User_Name="Usuario";

@XendraTable(Name="User/Contact",
...
Identifier="acb1d5a9-2af9-ac81-e873-f228168505a3",Synchronized="2017-08-16 11:41:05.0")
/** TableName=AD_User */
...
public static String es_PE_FIELD_ContactUser_TrxOrganization_Description="Organización que inicia ó ejecuta la transacción";

@XendraTrl(Identifier="60b976fe-5b8b-c634-66aa-c512786766cd")
public static String es_PE_FIELD_ContactUser_TrxOrganization_Help="La organización que inicia ó ejecuta la transacción (para otra organización). La organización poseedora puede no ser la organización de la transacción en un ambiente de buró de servicio; con servicios centralizados y transacciones inter- organización.";

@XendraTrl(Identifier="60b976fe-5b8b-c634-66aa-c512786766cd")
public static String es_PE_FIELD_ContactUser_TrxOrganization_Name="Organización de la Trans.";
...
public static final String FIELDNAME_ContactUser_TrxOrganization="60b976fe-5b8b-c634-66aa-c512786766cd";
...
Identifier="354816a9-5070-4afb-467e-fd0e046dce12",Synchronized="2017-08-05 16:52:55.0")
...
public static String es_PE_FIELD_ContactUser_UserContact_Description="ID de Usuario dentro del sistema";

@XendraTrl(Identifier="b52d6fec-4b24-8e99-eb2e-cdbcc2711ac7")
public static String es_PE_FIELD_ContactUser_UserContact_Help="La ID de usuario identifica un usuario único en el sistema";

@XendraTrl(Identifier="b52d6fec-4b24-8e99-eb2e-cdbcc2711ac7")
public static String es_PE_FIELD_ContactUser_UserContact_Name="Usuario";
...
public static final String FIELDNAME_ContactUser_UserContact="b52d6fec-4b24-8e99-eb2e-cdbcc2711ac7";
...
public static String es_PE_FIELD_ContactUser_Birthday_Description="Cumpleaños ó día de aniversario";

@XendraTrl(Identifier="830922e8-1d27-c401-7dce-1bc566732c24")
public static String es_PE_FIELD_ContactUser_Birthday_Help="Cumpleaños ó día de aniversario";

@XendraTrl(Identifier="830922e8-1d27-c401-7dce-1bc566732c24")
public static String es_PE_FIELD_ContactUser_Birthday_Name="Cumpleaños";
...
public static final String FIELDNAME_ContactUser_Birthday="830922e8-1d27-c401-7dce-1bc566732c24";
...
public static String es_PE_FIELD_ContactUser_BusinessPartner_Description="Identifica un Socio de Negocio";

@XendraTrl(Identifier="f05b6a7e-c911-8fcf-2b9b-86bd30a82f8a")
public static String es_PE_FIELD_ContactUser_BusinessPartner_Help="Un socio de negocio es cualquiera con quien usted realiza transacciones. Este puede incluir Proveedores; Clientes; Empleados ó Vendedores.";

@XendraTrl(Identifier="f05b6a7e-c911-8fcf-2b9b-86bd30a82f8a")
public static String es_PE_FIELD_ContactUser_BusinessPartner_Name="Socio de Negocio";
...
public static final String FIELDNAME_ContactUser_BusinessPartner="f05b6a7e-c911-8fcf-2b9b-86bd30a82f8a";
...
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="e06a18dd-dca4-587b-d270-cee8f4afb317",Synchronized="2017-08-05 16:52:55.0")
...
public static String es_PE_FIELD_ContactUser_PartnerLocation_Description="Identifica la dirección para este socio de negocio";

@XendraTrl(Identifier="d03a1c9f-3235-ba7a-5d02-ca34b86cdc5c")
public static String es_PE_FIELD_ContactUser_PartnerLocation_Help="La dirección de un socio indica la ubicación de un socio de negocio";

@XendraTrl(Identifier="d03a1c9f-3235-ba7a-5d02-ca34b86cdc5c")
public static String es_PE_FIELD_ContactUser_PartnerLocation_Name="Dirección del Socio del Negocio";
...
public static final String FIELDNAME_ContactUser_PartnerLocation="d03a1c9f-3235-ba7a-5d02-ca34b86cdc5c";
...
public static String es_PE_FIELD_ContactUser_Greeting_Description="Saludo para imprimir en la correspondencia";

@XendraTrl(Identifier="fef6bcd7-14b3-3cc2-9310-3de90c3716d5")
public static String es_PE_FIELD_ContactUser_Greeting_Help="Los saludos identifican los saludos a imprimir en la correspondencia";

@XendraTrl(Identifier="fef6bcd7-14b3-3cc2-9310-3de90c3716d5")
public static String es_PE_FIELD_ContactUser_Greeting_Name="Saludo";
...
public static final String FIELDNAME_ContactUser_Greeting="fef6bcd7-14b3-3cc2-9310-3de90c3716d5";
...
public static String es_PE_FIELD_ContactUser_Position_Description="Posición del trabajo";

@XendraTrl(Identifier="6402db5a-681d-0293-80ab-5e90ec41e4b4")
public static String es_PE_FIELD_ContactUser_Position_Name="Posición";
...
public static final String FIELDNAME_ContactUser_Position="6402db5a-681d-0293-80ab-5e90ec41e4b4";
...
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="99ea71fc-b941-1808-5536-157b3ad4ccba",Synchronized="2017-08-05 16:52:56.0")
...
public static String es_PE_FIELD_ContactUser_Comments_Description="Comentarios ó información adicional";

@XendraTrl(Identifier="a4f174eb-1f78-b691-3710-09f680d8cf9e")
public static String es_PE_FIELD_ContactUser_Comments_Help="El campo comentarios permite entrada en formato libre de información adicional";

@XendraTrl(Identifier="a4f174eb-1f78-b691-3710-09f680d8cf9e")
public static String es_PE_FIELD_ContactUser_Comments_Name="Comentarios";
...
public static final String FIELDNAME_ContactUser_Comments="a4f174eb-1f78-b691-3710-09f680d8cf9e";
...
/** ConnectionProfile AD_Reference=474037d5-3cef-9c8c-8e15-a0704cbfdc86 */
...
{
if (ConnectionProfile == null || ConnectionProfile.equals(REF_AD_UserConnectionProfile.VPN) || ConnectionProfile.equals(REF_AD_UserConnectionProfile.LAN) || ConnectionProfile.equals(REF_AD_UserConnectionProfile.TerminalServer) || ConnectionProfile.equals(REF_AD_UserConnectionProfile.WAN));
 else throw new IllegalArgumentException ("ConnectionProfile Invalid value - " + ConnectionProfile + " - Reference_ID=364 - V - L - T - W");
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="acd61a0c-5e9c-3eb1-41f5-7f809f34aba1",Synchronized="2017-08-05 16:52:56.0")
...
public static String es_PE_FIELD_ContactUser_Description_Description="Observación corta opcional del registro";

@XendraTrl(Identifier="d905e671-8d18-1a3f-f8e3-695e58113d23")
public static String es_PE_FIELD_ContactUser_Description_Help="Una Observación esta limitada a 255 caracteres";

@XendraTrl(Identifier="d905e671-8d18-1a3f-f8e3-695e58113d23")
public static String es_PE_FIELD_ContactUser_Description_Name="Observación";
...
public static final String FIELDNAME_ContactUser_Description="d905e671-8d18-1a3f-f8e3-695e58113d23";
...
public static String es_PE_FIELD_ContactUser_EMailAddress_Description="ID de correo electrónico";

@XendraTrl(Identifier="06bebca0-5cf0-e3fe-d094-405d2a374e60")
public static String es_PE_FIELD_ContactUser_EMailAddress_Help="El Email indica la ID de correo electrónico para este usuario";

@XendraTrl(Identifier="06bebca0-5cf0-e3fe-d094-405d2a374e60")
public static String es_PE_FIELD_ContactUser_EMailAddress_Name="Email";
...
public static final String FIELDNAME_ContactUser_EMailAddress="06bebca0-5cf0-e3fe-d094-405d2a374e60";
...
public static String es_PE_FIELD_ContactUser_EMailUserID_Description="ID de usuario del email";

@XendraTrl(Identifier="80f9ee4b-0b45-c71a-cbc1-3b8c7544a19b")
public static String es_PE_FIELD_ContactUser_EMailUserID_Help="El ID de usuario es normalmente el nombre antes del símbolo @ de su dirección de e-mail.";

@XendraTrl(Identifier="80f9ee4b-0b45-c71a-cbc1-3b8c7544a19b")
public static String es_PE_FIELD_ContactUser_EMailUserID_Name="ID Usuario";
...
public static final String FIELDNAME_ContactUser_EMailUserID="80f9ee4b-0b45-c71a-cbc1-3b8c7544a19b";
...
public static String es_PE_FIELD_ContactUser_EMailUserPassword_Description="Contraseña de su usuario de email";

@XendraTrl(Identifier="f493aa35-e3d8-3029-734b-df74fd2115e8")
public static String es_PE_FIELD_ContactUser_EMailUserPassword_Help="Requerido si el servidor de correo requiere autenticación para mandar  e-mail";

@XendraTrl(Identifier="f493aa35-e3d8-3029-734b-df74fd2115e8")
public static String es_PE_FIELD_ContactUser_EMailUserPassword_Name="Contraseña";
...
public static final String FIELDNAME_ContactUser_EMailUserPassword="f493aa35-e3d8-3029-734b-df74fd2115e8";
...
public static String es_PE_FIELD_ContactUser_VerificationInfo_Description="Verificación de la dirección de EMail";

@XendraTrl(Identifier="3e6a851b-5984-ae2e-7398-1e0dbc06794f")
public static String es_PE_FIELD_ContactUser_VerificationInfo_Help="El campo contiene la fecha que se ha verificado la dirección del email.";

@XendraTrl(Identifier="3e6a851b-5984-ae2e-7398-1e0dbc06794f")
public static String es_PE_FIELD_ContactUser_VerificationInfo_Name="Verificación de EMail";
...
public static final String FIELDNAME_ContactUser_VerificationInfo="3e6a851b-5984-ae2e-7398-1e0dbc06794f";
...
public static String es_PE_FIELD_ContactUser_EMailVerify_Name="Verificación de Email";
...
public static final String FIELDNAME_ContactUser_EMailVerify="ba4ea916-cdd9-f8af-baac-48bfd4100028";
...
IsCentrallyMaintained=true,AD_Tab_ID="ecdc18c1-5823-d6b1-de56-01074475b931",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=160,SortNo=0,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="5cfd3d81-294c-ad1b-2c2a-ab08a48d4a80")
...
public static String es_PE_FIELD_ContactUser_Fax_Description="Número de Fax";

@XendraTrl(Identifier="5b5746b3-751d-7d23-e137-51970fb3a37d")
public static String es_PE_FIELD_ContactUser_Fax_Help="El Fax indica un número de fax para este socio de negocio ó ubicación";

@XendraTrl(Identifier="5b5746b3-751d-7d23-e137-51970fb3a37d")
public static String es_PE_FIELD_ContactUser_Fax_Name="Fax";
@XendraField(AD_Column_ID="Fax",
IsCentrallyMaintained=true,AD_Tab_ID="cca304e4-17f2-1849-76c1-8fa0813b5951",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=160,SortNo=0,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="5b5746b3-751d-7d23-e137-51970fb3a37d")
public static final String FIELDNAME_ContactUser_Fax="5b5746b3-751d-7d23-e137-51970fb3a37d";
...
@XendraField(AD_Column_ID="Fax",
IsCentrallyMaintained=true,AD_Tab_ID="508b449f-672d-0e92-5d32-f9e3419fd6c6",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=120,SortNo=0,
IsSameLine=true,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="a892e91d-db9b-735a-d0d8-71ed9820dcfd")
...
public static String es_PE_FIELD_ContactUser_FullBPAccess_Description="El Usuario/contacto tiene un acceso total a la información del Socio del Negocio y recursos";

@XendraTrl(Identifier="774cca9f-649c-3a89-2b25-e81524e09839")
public static String es_PE_FIELD_ContactUser_FullBPAccess_Help="Si seleccionó, el usuario tiene acceso total a la información del Socio del Negocio (SN) tal como (Documentoi SN, Ordenes, Facturas, Solicitudes) o recursos (Activos, Descargas). Si lo deselecciona, el usuario no tiene ningún derecho de acceso a menos que usted lo conceda explícitamente en la  pestaña \"Acceso  SN\"";

@XendraTrl(Identifier="774cca9f-649c-3a89-2b25-e81524e09839")
public static String es_PE_FIELD_ContactUser_FullBPAccess_Name="Total Acceso SN";
...
public static final String FIELDNAME_ContactUser_FullBPAccess="774cca9f-649c-3a89-2b25-e81524e09839";
...
public static String es_PE_FIELD_UserContact_IsFullPriceListAccess_Name="IsFullPriceListAccess";
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="181ec738-47d4-851a-31f4-89ea2e79a6e4",Synchronized="2017-08-05 16:52:56.0")
...
public static String es_PE_FIELD_ContactUser_LastContact_Description="Fecha en que este individuo fue contactado por última vez";

@XendraTrl(Identifier="911b9897-e247-8811-a3e5-24552b879aeb")
public static String es_PE_FIELD_ContactUser_LastContact_Help="El último contacto indica la fecha en que el contacto de este socio de segocio fue contactado por última vez";

@XendraTrl(Identifier="911b9897-e247-8811-a3e5-24552b879aeb")
public static String es_PE_FIELD_ContactUser_LastContact_Name="Último Contacto";
...
public static final String FIELDNAME_ContactUser_LastContact="911b9897-e247-8811-a3e5-24552b879aeb";
...
public static String es_PE_FIELD_ContactUser_LastResult_Description="Resultado del último contacto";

@XendraTrl(Identifier="d7ac0d39-5aaa-24c4-49f4-ab1bc13c8ef8")
public static String es_PE_FIELD_ContactUser_LastResult_Help="El Último resultado identifica el resultado del último contacto hecho.";

@XendraTrl(Identifier="d7ac0d39-5aaa-24c4-49f4-ab1bc13c8ef8")
public static String es_PE_FIELD_ContactUser_LastResult_Name="Resultado Final";
...
public static final String FIELDNAME_ContactUser_LastResult="d7ac0d39-5aaa-24c4-49f4-ab1bc13c8ef8";
...
public static String es_PE_FIELD_ContactUser_LDAPUserName_Description="Autorización vía LDAP (directorio) servicios";

@XendraTrl(Identifier="03e95c90-db4d-fed3-34da-41102d7d0f6a")
public static String es_PE_FIELD_ContactUser_LDAPUserName_Help="Autorizan al usuario vía LDAP. Si la autorización de LDAP no puede ser obtenida, se rechaza el acceso - la contraseña no hace caso para el acceso local.";

@XendraTrl(Identifier="03e95c90-db4d-fed3-34da-41102d7d0f6a")
public static String es_PE_FIELD_ContactUser_LDAPUserName_Name="Autorización vía LDAP";
...
public static final String FIELDNAME_ContactUser_LDAPUserName="03e95c90-db4d-fed3-34da-41102d7d0f6a";
...
IsCentrallyMaintained=true,AD_Tab_ID="ecdc18c1-5823-d6b1-de56-01074475b931",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=30,SortNo=1,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="9a1e4300-4a39-ac48-0d63-e70a445fb55a")
...
public static String es_PE_FIELD_ContactUser_Name_Description="Identificador alfanumérico de la entidad.";

@XendraTrl(Identifier="c00c48fb-7f97-0271-c6eb-53134b3be376")
public static String es_PE_FIELD_ContactUser_Name_Help="El nombre de una entidad (registro) se usa como una opción de búsqueda predeterminada adicional a la clave de búsqueda. El nombre es de hasta 60 caracteres de longitud.";

@XendraTrl(Identifier="c00c48fb-7f97-0271-c6eb-53134b3be376")
public static String es_PE_FIELD_ContactUser_Name_Name="Nombre";
@XendraField(AD_Column_ID="Name",
IsCentrallyMaintained=true,AD_Tab_ID="cca304e4-17f2-1849-76c1-8fa0813b5951",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=60,IsReadOnly=false,SeqNo=40,SortNo=1,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="c00c48fb-7f97-0271-c6eb-53134b3be376")
public static final String FIELDNAME_ContactUser_Name="c00c48fb-7f97-0271-c6eb-53134b3be376";
...
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="2b90ebd1-dc8b-bfa6-43e5-d05d0a50406f")
...
/** NotificationType AD_Reference=a13bfa6b-9138-33c1-bd05-b4d49253c429 */
...
if (NotificationType.equals(REF_AD_UserNotificationType.None) || NotificationType.equals(REF_AD_UserNotificationType.EMailPlusNotice) || NotificationType.equals(REF_AD_UserNotificationType.EMail) || NotificationType.equals(REF_AD_UserNotificationType.Notice));
 else throw new IllegalArgumentException ("NotificationType Invalid value - " + NotificationType + " - Reference_ID=344 - X - B - E - N");
...
public static String es_PE_FIELD_ContactUser_NotificationType_Description="Tipo de Notificación";

@XendraTrl(Identifier="acbd7633-5208-83b8-af96-03e7eb99152d")
public static String es_PE_FIELD_ContactUser_NotificationType_Help="Correos ó notificaciones enviados para actualización de solicitudes, etc.";

@XendraTrl(Identifier="acbd7633-5208-83b8-af96-03e7eb99152d")
public static String es_PE_FIELD_ContactUser_NotificationType_Name="Tipo de Notificación";
...
public static final String FIELDNAME_ContactUser_NotificationType="acbd7633-5208-83b8-af96-03e7eb99152d";
...
VFormat="",ValueMin="",ValueMax="",Version="0",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="1cb872a7-57bd-f4fa-c87d-b25fb8e5cc57",Synchronized="2017-08-05 16:52:56.0")
...
public static String es_PE_FIELD_ContactUser_Password_Description="Contraseña de cualquier longitud (Sensible a mayúsculas y minúsculas)";

@XendraTrl(Identifier="a2366bee-ded0-bc38-165c-3a85f4a8a78c")
public static String es_PE_FIELD_ContactUser_Password_Help="La contraseña indica la contraseña para esta ID de usuario. Las contraseñas se requieren para identificar usuarios autorizados";

@XendraTrl(Identifier="a2366bee-ded0-bc38-165c-3a85f4a8a78c")
public static String es_PE_FIELD_ContactUser_Password_Name="Contraseña";
...
public static final String FIELDNAME_ContactUser_Password="a2366bee-ded0-bc38-165c-3a85f4a8a78c";
...
public static String es_PE_FIELD_ContactUser_Phone_Description="Identifica un número telefónico";

@XendraTrl(Identifier="f04c9166-8be3-f7c6-8012-5769d9cfb107")
public static String es_PE_FIELD_ContactUser_Phone_Help="El campo teléfono identifica un No. telefónico.";

@XendraTrl(Identifier="f04c9166-8be3-f7c6-8012-5769d9cfb107")
public static String es_PE_FIELD_ContactUser_Phone_Name="Teléfono";
...
public static final String FIELDNAME_ContactUser_Phone="f04c9166-8be3-f7c6-8012-5769d9cfb107";
...
public static String es_PE_FIELD_ContactUser_2ndPhone_Description="Identifica un número telefónico alterno";

@XendraTrl(Identifier="9f72d9dc-69f1-9fe0-b96d-ef91f95d219d")
public static String es_PE_FIELD_ContactUser_2ndPhone_Help="El campo teléfono 2 identifica un número telefónico alterno.";

@XendraTrl(Identifier="9f72d9dc-69f1-9fe0-b96d-ef91f95d219d")
public static String es_PE_FIELD_ContactUser_2ndPhone_Name="Teléfono 2";
...
public static final String FIELDNAME_ContactUser_2ndPhone="9f72d9dc-69f1-9fe0-b96d-ef91f95d219d";
...
public static String es_PE_FIELD_ContactUser_ProcessNow_Name="Procesar Ahora";
...
public static final String FIELDNAME_ContactUser_ProcessNow="7ca7cf72-fe83-0edd-7ba0-aba0bb8a401a";
...
public static String es_PE_FIELD_ContactUser_Supervisor_Description="Supervisor para este usuario - usado para escalación";

@XendraTrl(Identifier="f0fadcbc-1050-a07d-7e19-4489b838a23b")
public static String es_PE_FIELD_ContactUser_Supervisor_Help="El supervisor indica quien será usado para reenviar y escalar emisiones este usuario.";

@XendraTrl(Identifier="f0fadcbc-1050-a07d-7e19-4489b838a23b")
public static String es_PE_FIELD_ContactUser_Supervisor_Name="Supervisor";
...
public static final String FIELDNAME_ContactUser_Supervisor="f0fadcbc-1050-a07d-7e19-4489b838a23b";
...
VFormat="",ValueMin="",ValueMax="",Version="1",IsSelectionColumn=false,AD_Process_ID="",
IsAlwaysUpdateable=false,ColumnSQL="",IsAllowLogging=false,
Identifier="848ac078-21d2-9962-ac47-ff12d24fb4be",Synchronized="2017-08-05 16:52:56.0")
...
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=120,SortNo=0,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="e09cb825-47f5-a243-ee1b-4001e71ae1dc")
...
public static String es_PE_FIELD_ContactUser_Title_Description="Nombre como se conoce esta entidad";

@XendraTrl(Identifier="fa46452f-a616-478d-6d91-548ddfd7b17e")
public static String es_PE_FIELD_ContactUser_Title_Help="El título indica el nombre como se conoce esta entidad";

@XendraTrl(Identifier="fa46452f-a616-478d-6d91-548ddfd7b17e")
public static String es_PE_FIELD_ContactUser_Title_Name="Título";
@XendraField(AD_Column_ID="Title",
IsCentrallyMaintained=true,AD_Tab_ID="cca304e4-17f2-1849-76c1-8fa0813b5951",AD_FieldGroup_ID="",
IsDisplayed=true,DisplayLogic="",DisplayLength=20,IsReadOnly=false,SeqNo=120,SortNo=0,
IsSameLine=false,IsHeading=false,IsFieldOnly=false,Included_Tab_ID="",
Synchronized="2012-03-17 18:47:14.0",Identifier="fa46452f-a616-478d-6d91-548ddfd7b17e")
public static final String FIELDNAME_ContactUser_Title="fa46452f-a616-478d-6d91-548ddfd7b17e";
