...
import org.compiere.model.persistence.X_M_DistributionRunLine;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MDistributionRunLine.java 3654 2011-11-04 01:49:49Z xapiens $
 */
public class MDistributionRunLine extends X_M_DistributionRunLine
{
	...
	{
		if (m_product == null)
			m_product = MProduct.get(getCtx(), getM_Product_ID(), this.get_TrxName());
		return m_product;
	}	//	getProduct
