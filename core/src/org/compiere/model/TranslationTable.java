 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: TranslationTable.java 4091 2012-04-10 20:33:02Z xapiens $
 */
public class TranslationTable
{
	...
	public boolean createTranslation (PO po)
	{
		...
		//sql1.append("UPDATE  ").append(m_trlTableName).append(" SET (");
		sql.append("UPDATE  ").append(m_trlTableName).append(" trl SET ");
		...
		sql.append(m_baseTableName).append("_ID = b.").append(m_baseTableName).append("_ID,");
		sql.append("AD_Language = l.AD_Language,");
		sql.append("AD_Client_ID = b.AD_Client_ID,");
		sql.append("AD_Org_ID = b.AD_Org_ID,");
		sql.append("IsActive = b.IsActive,");
		sql.append("Created = b.Created,");
		sql.append("CreatedBy = b.CreatedBy,");
		sql.append("Updated = b.Updated,");
		sql.append("UpdatedBy = b.UpdatedBy,");
...
//		sql2.append(", b.AD_Client_ID,b.AD_Org_ID,b.IsActive, b.Created,b.CreatedBy,b.Updated,b.UpdatedBy, 'N'");
		...
		for (int i = 0; i < m_columns.size(); i++)
		{
			...
			if (value == null)
				continue;
			sql.append(columnName).append(" = b.").append(columnName);
...
//		sql.append(" FROM AD_Language l, " + m_baseTableName
//				+ " b WHERE l.IsActive = 'Y' AND l.IsSystemLanguage = 'Y' AND b."
//				+ m_baseTableName + "_ID=").append(po.get_ID());

		sql.append(" FROM AD_Language l, " + m_baseTableName 
				+ " b WHERE trl.AD_WF_Node_ID = b.AD_WF_Node_ID AND l.IsActive = 'Y' AND l.IsSystemLanguage = 'Y' AND b.AD_WF_Node_ID=").append(po.get_ID());
	...
	public boolean resetTranslationFlag (PO po)
	{
		...
		sb.append(m_trlTableName)
			.append(" SET IsTranslated='N',Updated=CURRENT_TIMESTAMP WHERE ")
