 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MElement.java 5609 2015-08-06 02:09:23Z xapiens $
 */
public class MElement extends X_C_Element
{
	...
	public MElement (MClient client, String Name, String ElementType, int AD_Tree_ID)
	{
		...
		setIsNaturalAccount(REF_C_ElementType.Account.equals(ElementType));
	}	//	MElement
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//	Natural Account
		if (REF_C_ElementType.UserDefined.equals(elementType) && isNaturalAccount())
			setIsNaturalAccount(false);
		//	Tree validation
		...
		if (REF_C_ElementType.UserDefined.equals(elementType))
		{
			if (REF_AD_TreeTypeType.User1.equals(treeType) || REF_AD_TreeTypeType.User2.equals(treeType))
				;
			else
			{
