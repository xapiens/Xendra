 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MPaymentValidate.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MPaymentValidate
{
	...
	public static String validateCreditCardNumber (String creditCardNumber, String creditCardType)
	{
		...
		//
		if (creditCardType.equals(REF_C_PaymentCreditCardType.MasterCard))
		{
			ccStartList = "51,52,53,54,55";
			ccLengthList = "16";
		}
		else if (creditCardType.equals(REF_C_PaymentCreditCardType.Visa))
		{
			ccStartList = "4";
			ccLengthList = "13,16";
		}
		else if (creditCardType.equals(REF_C_PaymentCreditCardType.Amex))
		{
			ccStartList = "34,37";
			ccLengthList = "15";
		}
		else if (creditCardType.equals(REF_C_PaymentCreditCardType.Discover))
		{
			ccStartList = "6011";
			ccLengthList = "16";
		}
		else if (creditCardType.equals(REF_C_PaymentCreditCardType.Diners))
		{
	...
	public static String validateCreditCardVV (String creditCardVV, String creditCardType)
	{
		...
		//	Amex = 4 digits
		if (creditCardType.equals(REF_C_PaymentCreditCardType.Amex))
		{
			if (length == 4)
			{
				try
		...
		if (creditCardType.equals(REF_C_PaymentCreditCardType.Visa) 
			|| creditCardType.equals(REF_C_PaymentCreditCardType.MasterCard))
		{
			if (length == 3)
			{
				try
