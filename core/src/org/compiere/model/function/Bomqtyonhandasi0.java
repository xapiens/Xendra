...
public class Bomqtyonhandasi0 
{
 
@XendraFunction(Name="bomqtyonhandasi",Output="numeric",Owner="xendra",Language="plpgsql",
Identifier="36c9cc19-d007-01de-43e4-0b3032c1c6f9",
...
Extension="",Synchronized="2013-09-29 01:27:28.0")
	public static final String Identifier = "36c9cc19-d007-01de-43e4-0b3032c1c6f9";
	...
	public static final String getCode() 
{
	...
	sb.appendln("v_ProductQty := BomqtyonhandASI (bom.M_ProductBOM_ID, AttributeSetInstance_ID, myWarehouse_ID, Locator_ID);");
	sb.appendln("-- How much can we make overall");
	sb.appendln("IF (v_ProductQty < v_Quantity) THEN");
	sb.appendln("v_Quantity := v_ProductQty;");
	sb.appendln("END IF;");
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=36c9cc19-d007-01de-43e4-0b3032c1c6f9");
	return sb.toString();
}
}
