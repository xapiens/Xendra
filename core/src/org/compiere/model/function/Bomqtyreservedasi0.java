...
public class Bomqtyreservedasi0 
{
 
@XendraFunction(Name="bomqtyreservedasi",Output="numeric",Owner="xendra",Language="plpgsql",
Identifier="8e3183f5-a228-8b99-d01f-aa2678f1f9c0",
Arguments="p_product_id numeric, attributesetinstance_id numeric, p_warehouse_id numeric, p_locator_id numeric",
Extension="",Synchronized="2013-09-29 01:27:28.0")
	public static final String Identifier = "8e3183f5-a228-8b99-d01f-aa2678f1f9c0";
	...
	public static final String getCode() 
{
	...
	sb.appendln("SELECT COALESCE(SUM(QtyReserved), 0)");
	...
	sb.appendln("  AND (s.M_AttributeSetInstance_ID = AttributeSetInstance_ID OR COALESCE(AttributeSetInstance_ID,0) = 0);");
	sb.appendln("--");
	...
	sb.appendln("v_ProductQty := BomqtyreservedASI (bom.M_ProductBOM_ID, AttributeSetInstance_ID, v_Warehouse_ID, p_Locator_ID);");
	sb.appendln("-- How much can we make overall");
	sb.appendln("IF (v_ProductQty < v_Quantity) THEN");
	sb.appendln("v_Quantity := v_ProductQty;");
	sb.appendln("END IF;");
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=8e3183f5-a228-8b99-d01f-aa2678f1f9c0");
	return sb.toString();
}
}
