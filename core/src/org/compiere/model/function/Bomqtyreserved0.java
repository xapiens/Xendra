...
public class Bomqtyreserved0 
{
 
@XendraFunction(Name="bomqtyreserved",Output="numeric",Owner="xendra",Language="plpgsql",
Identifier="49b6b081-adc5-5dee-ecd5-d1386b7a941b",
Arguments="p_product_id numeric, p_warehouse_id numeric, p_locator_id numeric",Extension="",
Synchronized="2013-09-29 01:27:28.0")
	public static final String Identifier = "49b6b081-adc5-5dee-ecd5-d1386b7a941b";
	...
	public static final String getCode() 
{
	...
	sb.appendln("v_ProductQty := Bomqtyreserved (bom.M_ProductBOM_ID, v_Warehouse_ID, p_Locator_ID);");
	sb.appendln("-- How much can we make overall");
	sb.appendln("IF (v_ProductQty < v_Quantity) THEN");
	sb.appendln("v_Quantity := v_ProductQty;");
	sb.appendln("END IF;");
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=49b6b081-adc5-5dee-ecd5-d1386b7a941b");
	return sb.toString();
}
}
