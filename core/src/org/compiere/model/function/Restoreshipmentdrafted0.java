...
public class Restoreshipmentdrafted0 
{
 
@XendraFunction(Name="restoreshipmentdrafted",Output="void",Owner="xendra",Language="plpgsql",
Identifier="cf154a61-c197-ec77-8399-822fe8cf76ab",Arguments="p_pinstance_id numeric",Extension="",
Synchronized="2013-09-29 01:27:28.0")
	public static final String Identifier = "cf154a61-c197-ec77-8399-822fe8cf76ab";
	...
	public static final String getCode() 
{
	...
	sb.appendln("		ELSIF (p.ParameterName = 'M_InOut_ID') THEN");
	sb.appendln("			p_M_InOut_ID := p.P_Number;");
	sb.appendln("		END IF;");
	...
	sb.appendln("	WHERE");
	sb.appendln("		M_InOut_ID=p_M_InOut_ID");
	sb.appendln("	;");
	sb.appendln("	UPDATE");
	sb.appendln("		M_InOutLine");
	sb.appendln("	SET");
	sb.appendln("		Processed='N'");
	sb.appendln("	WHERE");
	sb.appendln("		M_InOut_ID=p_M_InOut_ID");
	sb.appendln("	;");
	sb.appendln("	Message:='Shipment '||p_M_InOut_ID||' successfully drafted.';");
	sb.appendln("	UPDATE");
	...
	sb.appendln("		    M_Transaction");
	sb.appendln("		WHERE");
	sb.appendln("		    M_InOutLine_ID=p.M_InOutLine_ID");
	sb.appendln("		;");
	...
	sb.appendln("	WHERE");
	sb.appendln("		    AD_Table_ID=table_name2id('M_InOut')");
	sb.appendln("		AND Record_ID=p_M_InOut_ID");
	sb.appendln("	;");
	sb.appendln("	--delete account ");
	sb.appendln("END;");
	return sb.toString();
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=cf154a61-c197-ec77-8399-822fe8cf76ab");
	return sb.toString();
}
}
