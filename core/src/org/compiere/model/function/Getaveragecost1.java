...
Extension="",Synchronized="2020-03-05 23:08:26.0")
	...
	public static final String getCode() 
{
	...
	sb.appendln("lastcost NUMERIC;");
	sb.appendln("BEGIN");
	sb.appendln("select max(m_costCalc_ID) into lastcost from m_costCalc ");
	...
	sb.appendln("end if;");
	sb.appendln("select cost from m_costcalc where m_costCalc_ID = lastcost");
...
{
 	StrBuilder sb = new StrBuilder();
 	sb.appendln("@Synchronized=2020-03-05 23:08:26.0");
