	...
	public static final String getCode() 
{
	...
	sb.appendln("           return ROUND(COALESCE(v_TotalOpenAmt,0), v_Precision);");
	sb.appendln("	END IF;");
	sb.appendln("    END IF;");
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=db8f3f63-421a-0a51-3f18-dacc34e849d3");
	return sb.toString();
}
}
