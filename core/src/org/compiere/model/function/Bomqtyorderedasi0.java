...
public class Bomqtyorderedasi0 
{
 
@XendraFunction(Name="bomqtyorderedasi",Output="numeric",Owner="xendra",Language="plpgsql",
Identifier="5ded05ee-cbe0-28bd-6054-af8329a6a18f",
...
Extension="",Synchronized="2013-09-29 01:27:28.0")
	public static final String Identifier = "5ded05ee-cbe0-28bd-6054-af8329a6a18f";
	...
	public static final String getCode() 
{
	...
	sb.appendln("v_ProductQty := BomqtyorderedASI (bom.M_ProductBOM_ID, AttributeSetInstance_ID, v_Warehouse_ID, p_Locator_ID);");
	sb.appendln("-- How much can we make overall");
	sb.appendln("IF (v_ProductQty < v_Quantity) THEN");
	sb.appendln("v_Quantity := v_ProductQty;");
	sb.appendln("END IF;");
	...
	public static final String getComments() 
{
	...
	sb.appendln("@Identifier=5ded05ee-cbe0-28bd-6054-af8329a6a18f");
	return sb.toString();
}
}
