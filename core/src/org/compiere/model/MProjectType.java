...
import org.compiere.model.persistence.X_C_ProjectType;
 ...
 *
 *	@author Jorg Janke
 *	@version $Id: MProjectType.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MProjectType extends X_C_ProjectType
{
		...
		Timestamp startDate, MRole role)
	{
		...
		{
			orderBy = "p.SeqNo"; 
			groupBy = "COALESCE(p.Name,('-')), p.C_Phase_ID, p.SeqNo ";
			sb.append(groupBy)
