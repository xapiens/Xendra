...
/**
 *	City Model (Value Object)
 *
 *  @author 	Xapiens
 *  @version 	$Id: MCity.java 508 2007-11-24 23:06:53Z el_man $
 */
	...
	implements Comparator, Serializable
{
	...
	public static MCity[] getCities(MRegion region) 
	{
		if (region == null)
			return null;
	...
	public static MCity getFirst(MRegion region) 
	{
		if (region == null)
			return null;
		String whereClause = "C_Region_ID = ?";
	...
	public static MCity get(Properties ctx, int C_City_ID) {
		MCity c = new MCity (ctx, C_City_ID, null);
		if (c.getC_City_ID()  == C_City_ID)
		{
			return c;
		}
