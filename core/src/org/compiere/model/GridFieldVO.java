 ...
 *  @version  $Id: GridFieldVO.java 5393 2014-06-29 18:26:31Z xapiens $
 */
		...
		int AD_Window_ID, int AD_Tab_ID, boolean readOnly, ResultSet rs)
	{
		...
		try
		{
			...
			for (int i = 1; i <= rsmd.getColumnCount(); i++)
			{
				...
				else if (columnName.equalsIgnoreCase("AD_Rule_ID"))
					vo.AD_Rule_ID = rs.getInt(i);
				else if (columnName.equalsIgnoreCase("Agenda"))
					vo.Agenda = rs.getString(i);
...
//				Feature Request FR [ 2003044 ]
		...
		if (	vo.ColumnName.equals("CreatedBy") ||
				vo.ColumnName.equals("UpdatedBy") ||
				vo.ColumnName.equals("Created") ||
				vo.ColumnName.equals("Updated")	)
		{
