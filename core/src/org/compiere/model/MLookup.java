 ...
 *  </pre>
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MLookup.java 5003 2013-08-13 15:42:35Z xapiens $
 */
public final class MLookup extends Lookup implements Serializable
{
	...
	// Set validation que permite agregar validaciones sin tanta huevada :)
	public void setValidation(String validationcode) {
		m_info.ValidationCode = m_info.ValidationCode.concat(validationcode);			
	}
	...
	class MLoader extends Thread implements Serializable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				//System.out.println("MLookup->MLoader.run"+sql);
				ResultSet rs = pstmt.executeQuery();
				//	Get first ... rows
				m_allLoaded = true;
				while (rs.next())
