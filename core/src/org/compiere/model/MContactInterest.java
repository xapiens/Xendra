...
import org.compiere.model.persistence.X_R_ContactInterest;
import org.compiere.util.*;
 
/**
 *  Business Partner Contact Interest.
 *  Xendra compies with spamming laws.
 *  If the opt out date is set (by the user), 
 *  you should not subscribe the user again.
 *  Internally, the isActive flag is used.
 *
 *  @author Jorg Janke
 *  @version $Id: MContactInterest.java 3654 2011-11-04 01:49:49Z xapiens $
 */
