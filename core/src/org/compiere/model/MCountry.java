 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: MCountry.java 5721 2016-01-02 23:13:51Z xapiens $
 */
	...
	implements Comparator, Serializable
{
	...
	private static Boolean loadCountry(String language, String countryCode,Properties ctx) {
		s_countries = new CCache<String,MCountry>("C_Country", 5);
		Boolean isLoaded = false;
		String AD_Language = language+"_"+countryCode;
		String sql = String.format("SELECT * FROM C_Country WHERE IsActive='Y' AND AD_Language='%s'",AD_Language);
		try
		{
	...
	private static void loadAllCountries (Properties ctx)
	{
		...
		//s_countries = new CCache<String,MCountry>("C_Country", 5);
		//String sql = String.format("SELECT * FROM C_Country WHERE IsActive='Y' AND CountryCode='%s'",lang.getCountryCode());
	...
	public static MCountry getCountryByCode (Properties ctx,String countrycode)
	{
		MCountry c = null;
		//
