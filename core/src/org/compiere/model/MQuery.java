 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MQuery.java 4251 2012-07-19 20:24:53Z xapiens $
 * 
 * @author Teo Sarca
...
public class MQuery implements Serializable
{
	...
	public void addRestriction (String whereClause)
	{
		...
		for (Restriction relem:m_list)
		{
			if (relem.DirectWhereClause != null)
			{
				if (relem.DirectWhereClause.equals(r.DirectWhereClause))
