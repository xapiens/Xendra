 ...
 *
 *	@author Jorg Janke
 *	@version $Id: MAttribute.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MAttribute extends X_M_Attribute
{
	...
	public MAttribute (Properties ctx, int M_Attribute_ID, String trxName)
	{
		...
		if (M_Attribute_ID == 0)
		{
			setAttributeValueType(REF_M_AttributeValueType.StringMax40);
	...
	{
		if (m_values == null && REF_M_AttributeValueType.List.equals(getAttributeValueType()))
		{
