...
import org.compiere.model.persistence.X_M_InOutConfirm;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MInOutConfirm.java 5822 2016-06-15 22:56:06Z xapiens $
 */
public class MInOutConfirm extends X_M_InOutConfirm implements DocAction
{
	...
	{
		return MRefList.getListName (getCtx(), REF_M_InOutConfirmType.Identifier, getConfirmType());
	}	//	getConfirmTypeName
	...
	private boolean createDifferenceDoc (MInOut inout, MInOutLineConfirm confirm)
	{
			...
			&& !inout.isSOTrx() && inout.getRef_InOut_ID() != 0)
		{
			...
			if (m_creditMemo == null)
			{
				...
				m_creditMemo.setC_DocTypeTarget_ID(REF_C_DocTypeDocBaseType.APCreditMemo);
