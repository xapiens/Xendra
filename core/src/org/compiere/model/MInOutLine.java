 ...
 *
 *  @author Jorg Janke
 *  @version $Id: MInOutLine.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MInOutLine extends X_M_InOutLine
{
	...
	{
		if (getParent().getDocStatus().equals(REF__DocumentStatus.Drafted))
			return true;		
	...
	{
		if (REF_C_LandedCostDistribution.Costs.equals(CostDistribution))
		{
			//	TODO Costs!
			log.severe("Not Implemented yet - Cost");
			return Env.ZERO;
		}
		else if (REF_C_LandedCostDistribution.Line.equals(CostDistribution))
			return Env.ONE;
		else if (REF_C_LandedCostDistribution.Quantity.equals(CostDistribution))
			return getMovementQty();
		else if (REF_C_LandedCostDistribution.Volume.equals(CostDistribution))
		{
			MProduct product = getProduct();
			if (product == null)
			{
		...
		else if (REF_C_LandedCostDistribution.Weight.equals(CostDistribution))
		{
			MProduct product = getProduct();
			if (product == null)
			{
