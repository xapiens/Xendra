...
import org.compiere.model.persistence.X_M_AttributeSetExclude;
import org.compiere.model.persistence.X_M_LotCtlExclude;
import org.compiere.model.persistence.X_M_SerNoCtlExclude;
 ...
 *
 *	@author Jorg Janke
 *	@version $Id: MAttributeSet.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MAttributeSet extends X_M_AttributeSet
{
	...
	public MAttributeSet (Properties ctx, int M_AttributeSet_ID, String trxName)
	{
		...
		//	setName (null);
			...
			setMandatoryType (REF_M_AttributeSetMandatoryType.NotMandatary);
		}
	}	//	MAttributeSet
	...
	{
		return !REF_M_AttributeSetMandatoryType.NotMandatary.equals(getMandatoryType())
			|| (isLot() && isLotMandatory())
			|| (isSerNo() && isSerNoMandatory())
			|| (isGuaranteeDate() && isGuaranteeDateMandatory());
	}	//	isMandatory
	...
	{
		return REF_M_AttributeSetMandatoryType.AlwaysMandatory.equals(getMandatoryType());
	}	//	isMandatoryAlways
	...
	{
		return REF_M_AttributeSetMandatoryType.WhenShipping.equals(getMandatoryType());
	}	//	isMandatoryShipping
