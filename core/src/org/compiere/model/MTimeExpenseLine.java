...
import org.compiere.model.persistence.X_S_TimeExpenseLine;
 ...
 *
 *	@author Jorg Janke
 *	@version $Id: MTimeExpenseLine.java 4366 2012-09-11 22:22:27Z xapiens $
 */
public class MTimeExpenseLine extends X_S_TimeExpenseLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (newRecord || is_ValueChanged("ExpenseAmt") || is_ValueChanged("C_Currency_ID"))
		{
			...
			{
				setConvertedAmt(MConversionRate.convert (getCtx(), getExpenseAmt(), getC_Currency_ID(), getC_Currency_Report_ID(), 
