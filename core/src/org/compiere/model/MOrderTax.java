...
import org.compiere.model.persistence.X_C_OrderTax;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MOrderTax.java 3654 2011-11-04 01:49:49Z xapiens $
 */
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				if (!documentLevel)		// calculate line tax
					if (tax.isSubstract())
						taxAmt = taxAmt.subtract(tax.calculateTax(baseAmt, isTaxIncluded(), getPrecision()));
					else
