 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MCashBook.java 5704 2015-11-20 12:22:28Z xapiens $
 */
public class MCashBook extends X_C_CashBook
{
	 ...
	 *	@param ctx context
	 *	@param COLUMNNAME_AD_Org_ID org
	 *	@param C_Currency_ID currency
	 *	@return cash book or null
	 */
	public static MCashBook get (Properties ctx, String Value)
	{
		//	Try from cache
		...
		String sql = "SELECT * FROM C_CashBook "
			+ "WHERE Value=? ORDER BY IsDefault DESC";
