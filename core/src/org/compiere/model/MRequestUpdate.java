...
import org.compiere.model.persistence.X_R_RequestUpdate;
import org.compiere.model.reference.REF_R_RequestConfidential;

/**
 * 	Request Update Model
 *  @author Jorg Janke
 *  @version $Id: MRequestUpdate.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MRequestUpdate extends X_R_RequestUpdate
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		if (getConfidentialTypeEntry() == null)
			setConfidentialTypeEntry(REF_R_RequestConfidential.PublicInformation);
		return true;
	}	//	beforeSave
