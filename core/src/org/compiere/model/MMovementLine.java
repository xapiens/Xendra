 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MMovementLine.java 4751 2013-03-04 16:21:51Z xapiens $
 */
public class MMovementLine extends X_M_MovementLine
{
	...
	public MProduct getProduct()
	{
		if (getM_Product_ID() != 0)
			return MProduct.get(getCtx(), getM_Product_ID(), get_TrxName());
		return null;
	}	//	getProduct
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		{
			if  
				( getM_AttributeSetInstance_ID() == 0 || getM_AttributeSetInstanceTo_ID() == 0 )
			{				
	...
	public static MMovementLine getbyIdentifier(String movementLineID, String trxName) {
		MMovementLine line = new Query(Env.getCtx(), MMovementLine.Table_Name, "identifier = ? ", trxName).setParameters(movementLineID).first();
		return line;
	}
