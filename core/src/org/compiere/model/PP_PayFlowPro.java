 ...
 *
 *  @author  Jorg Janke
 *  @version $Id: PP_PayFlowPro.java 5583 2015-08-05 14:11:58Z xapiens $
 */
	...
	implements Serializable
{
	...
	public PP_PayFlowPro()
	{
		super();
		m_pp = new PFProAPI();
		String path = Ini.getXendraHome() + File.separator + "lib";
	...
	public boolean processCC () throws IllegalArgumentException
	{
		...
		//  Transaction Type
		if (p_mp.getTrxType().equals(REF_C_PaymentTrxType.Sales))
