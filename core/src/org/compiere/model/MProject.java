 ...
 *
 *	@author Jorg Janke
 *	@version $Id: MProject.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MProject extends X_C_Project
{
	...
	public MProject (Properties ctx, int C_Project_ID, String trxName)
	{
		...
		//	setProjectCategory(PROJECTCATEGORY_General);
			setProjInvoiceRule(REF_C_ProjectInvoiceRule.None);
			setProjectLineLevel(REF_C_ProjectLineLevel.Project);
	...
	public void setProjectType (MProjectType type)
	{
		...
		if (REF_C_ProjectTypeCategory.ServiceChargeProject.equals(getProjectCategory()))
			copyPhasesFrom(type);
	}	//	setProjectType
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		if (newRecord && success)
		{
			...
			insert_Tree(REF_AD_TreeTypeType.Project);
		}
	...
	{
		if (success)
			delete_Tree(REF_AD_TreeTypeType.Project);
		return success;
	}	//	afterDelete
