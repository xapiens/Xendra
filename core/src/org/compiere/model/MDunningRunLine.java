...
import org.compiere.model.persistence.X_C_DunningRunLine;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MDunningRunLine.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MDunningRunLine extends X_C_DunningRunLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (getInvoice()!=null && getInvoice().getInvoiceCollectionType ()==null)			
		{
			if (m_invoice!=null)
			{
				m_invoice.setInvoiceCollectionType (REF_C_InviceInvoiceCollectionType.Dunning);
				m_invoice.save ();
			}
		}
		//
