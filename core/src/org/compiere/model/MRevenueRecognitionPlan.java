...
import org.compiere.model.persistence.X_C_RevenueRecognition_Plan;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MRevenueRecognitionPlan.java 4091 2012-04-10 20:33:02Z xapiens $
 */
		...
		if (newRecord)
		{
			...
			if (rr.isTimeBased())
			{
				...
				VALUES
					...
					:new.AD_Client_ID,:new.AD_Org_ID,'Y',CURRENT_TIMESTAMP,:new.CreatedBy,CURRENT_TIMESTAMP,:new.UpdatedBy,
