...
import org.compiere.model.persistence.X_AD_ClientShare;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MClientShare.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MClientShare extends X_AD_ClientShare
{
		...
		if (s_shares.isEmpty())
		{
			...
			try
			{
				...
				while (rs.next ())
				{
					...
					if (ShareType.equals(REF_AD_ClientShareType.ClientAllShared))
						s_shares.put(key, Boolean.TRUE);
					else if (ShareType.equals(REF_AD_ClientShareType.OrgNotShared))
	...
	{
		return getShareType().equals(REF_AD_ClientShareType.ClientAllShared);
	}	//	isClientLevelOnly
	...
	{
		return getShareType().equals(REF_AD_ClientShareType.OrgNotShared);
	}	//	isOrgLevelOnly
