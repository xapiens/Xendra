 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MTableAccess.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MTableAccess extends X_AD_Table_Access
{
	...
	public String toString()
	{
		...
		if (REF_AD_Table_AccessRuleType.Accessing.equals(getAccessTypeRule()))
			sb.append("-ReadOnly=").append(isReadOnly());
		else if (REF_AD_Table_AccessRuleType.Exporting.equals(getAccessTypeRule()))
			sb.append("-CanExport=").append(isCanExport());
		else if (REF_AD_Table_AccessRuleType.Reporting.equals(getAccessTypeRule()))
