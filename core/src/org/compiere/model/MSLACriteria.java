...
import org.compiere.model.persistence.X_PA_SLA_Criteria;
 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MSLACriteria.java 3654 2011-11-04 01:49:49Z xapiens $
 */
public class MSLACriteria extends X_PA_SLA_Criteria
{
	...
	public SLACriteria newInstance() throws Exception
	{
		if (getClassname() == null || getClassname().length() == 0)
			throw new XendraSystemError("No SLA Criteria Classname");
		...
		{
			throw new XendraSystemError("Could not intsnciate SLA Criteria", e);
		}
	}	//	newInstance
