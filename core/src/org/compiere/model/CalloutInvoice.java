 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CalloutInvoice.java 4091 2012-04-10 20:33:02Z xapiens $
 */
public class CalloutInvoice extends CalloutEngine
{
	...
	public String reference (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) 
	{
		if (isCalloutActive() || value == null)
			return "";
		setCalloutActive(true);
...
//	 *	@return null or error message
//	 *//*
//	public String status (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
//	{
//		int C_Invoice_ID = Env.getContextAsInt(ctx, Env.WINDOW_INFO, Env.TAB_INFO, "C_Invoice_ID");
//		String DocStatus = Env.getContext(ctx, Env.WINDOW_INFO, Env.TAB_INFO, "DocStatus");
//		Timestamp StatusDate = Env.getContextAsDate(ctx, WindowNo, "DateAcct");
//		X_C_InvoiceStatus invoicestatus = new X_C_InvoiceStatus(ctx, 0, "");
//		invoicestatus.setAD_Org_ID(Env.getAD_Org_ID(ctx));
//		invoicestatus.setAD_Client_ID(Env.getAD_Client_ID(ctx));
//		invoicestatus.setC_Invoice_ID(C_Invoice_ID);
//		invoicestatus.setStatusDate(StatusDate);		
//		invoicestatus.setDocStatus(DocStatus);
//		return "";
//	}	//	status
