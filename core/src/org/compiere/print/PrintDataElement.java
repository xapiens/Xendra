 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: PrintDataElement.java 1109 2009-12-24 13:41:29Z xapiens $
 */
	...
	private String getValueDisplay_Location ()
	{
		try
		{
			...
			if (C_Location_ID != 0)
			{
				...
				if (loc != null)
					// TODO xapiens changed from loc.toStringCR to loc.toString for Peruvian Forms 20/11/09 
					//return loc.toStringCR();
					return loc.toString();
			}
		}
