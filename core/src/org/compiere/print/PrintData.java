 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: PrintData.java 5822 2016-06-15 22:56:06Z xapiens $
 */
public class PrintData implements Serializable
{
	...
	/**	XML Element Name			*/
	public static final String	XML_TAG = "xendraData";
	/**	XML Row Name				*/
	...
	public static void main(String[] args)
	{
		...
		pd.createXML("/home/americas/printData.xml");
		...
		//	parse
		System.out.println("");
		PrintData pd1 = parseXML (new Properties(), new File("/home/americas/printData.xml"));
