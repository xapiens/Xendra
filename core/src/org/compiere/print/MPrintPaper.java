...
import org.compiere.model.persistence.X_AD_PrintPaper;
 ...
 *  
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MPrintPaper.java 5583 2015-08-05 14:11:58Z xapiens $
 * 
 * @author Teo Sarca
...
public class MPrintPaper extends X_AD_PrintPaper
{
	...
	public int getUnitsInt()
	{
		...
		if (du == null || REF_AD_PrintPaperUnits.MM.equals(du))
			return Size2DSyntax.MM;
		else if (REF_AD_PrintPaperUnits.Inch.equals(du))
			return Size2DSyntax.INCH; 
		else
			throw new XendraException("@NotSupported@ @DimensionUnit@ : "+du);
	}	//	getUnits
