...
import org.compiere.model.persistence.X_AD_PrintTableFormat;
 ...
 * 	@version 	$Id: MPrintTableFormat.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MPrintTableFormat extends X_AD_PrintTableFormat
{
	...
	public Stroke getHeader_Stroke()
	{
		if (header_Stroke == null)
		{
			...
			if (getHdrStrokeType() == null || REF_AD_PrintTableFormatStroke.SolidLine.equals(getHdrStrokeType()))
				header_Stroke = new BasicStroke(width);					//	-
			//
			else if (REF_AD_PrintTableFormatStroke.DashedLine.equals(getHdrStrokeType()))
				header_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
					1.0f, getPatternDashed(width), 0.0f);				//	- -
			else if (REF_AD_PrintTableFormatStroke.DottedLine.equals(getHdrStrokeType()))
				header_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
					1.0f, getPatternDotted(width), 0.0f);				//	. . .
			else if (REF_AD_PrintTableFormatStroke.Dash_DottedLine.equals(getHdrStrokeType()))
				header_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
	...
	public Stroke getHLine_Stroke()
	{
		if (lineH_Stroke == null)
		{
			...
			if (getHdrStrokeType() == null || REF_AD_PrintTableFormatStroke.DottedLine.equals(getLineStrokeType()))
				lineH_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
					1.0f, getPatternDotted(width), 0.0f);			//	. . .
			//		
			else if (REF_AD_PrintTableFormatStroke.SolidLine.equals(getLineStrokeType()))
				lineH_Stroke = new BasicStroke(width);				//	-
			else if (REF_AD_PrintTableFormatStroke.DashedLine.equals(getLineStrokeType()))
				lineH_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
					1.0f, getPatternDashed(width), 0.0f);			//	- -
			else if (REF_AD_PrintTableFormatStroke.Dash_DottedLine.equals(getLineStrokeType()))
				lineH_Stroke = new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 
					1.0f, getPatternDash_Dotted(width), 0.0f);		//	- . -
			//	default / fallback
			if (lineH_Stroke == null)
