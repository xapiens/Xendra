 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: StringElement.java 5583 2015-08-05 14:11:58Z xapiens $
 */
			...
			else
			{
				...
				while (measurer.getPosition() < iter.getEndIndex())
				{
					...
					if (p_maxHeight == 0f || (height + lineHeight) <= p_maxHeight)
					{
						...
						else if ((REF_AD_PrintFieldAlignment.TrailingRight.equals(p_FieldAlignmentType) && layout.isLeftToRight())
							|| (REF_AD_PrintFieldAlignment.LeadingLeft.equals(p_FieldAlignmentType) && !layout.isLeftToRight()))
						...
						else if (REF_AD_PrintFieldAlignment.Block.equals(p_FieldAlignmentType) && measurer.getPosition() < iter.getEndIndex())
						{
