 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: PrintElement.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public abstract class PrintElement implements ImageObserver
{
		...
		String FieldAlignmentType)
	{
		...
		if (p_FieldAlignmentType == null || p_FieldAlignmentType.equals(REF_AD_PrintFieldAlignment.Default))
			p_FieldAlignmentType = REF_AD_PrintFieldAlignment.LeadingLeft;
		//
		p_sizeCalculated = calculateSize();
	}	//	layout
