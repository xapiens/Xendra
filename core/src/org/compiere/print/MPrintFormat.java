 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MPrintFormat.java 5822 2016-06-15 22:56:06Z xapiens $
 */
public class MPrintFormat extends X_AD_PrintFormat
{
    	...
    	MPrintFormatItem[] toItems)
    {
        ...
        {   
            ...
            .append(" SET PrintName  = old.PrintName, ") 
            .append(" PrintNameSuffix = old.PrintNameSuffix, ") 
            .append(" IsTranslated = old.IsTranslated ")
            .append(" FROM AD_PrintFormatItem_Trl old ")
            .append(" WHERE  new.AD_PrintFormatItem_ID=").append(toID)            
            .append(" AND old.AD_Language=new.AD_Language ")
            .append(" AND old.AD_PrintFormatItem_ID =").append(fromID)            
