 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MPrintFormatItem.java 5583 2015-08-05 14:11:58Z xapiens $
 */
public class MPrintFormatItem extends X_AD_PrintFormatItem
{
	...
	public MPrintFormatItem (Properties ctx, int AD_PrintFormatItem_ID, String trxName)
	{
		...
		{
			setFieldAlignmentType(REF_AD_PrintFieldAlignment.Default);
			setLineAlignmentType(REF_AD_PrintLineAlignment.None);
			setPrintFormatType(REF_AD_PrintFormatType.Text);
			setPrintAreaType(REF_AD_PrintArea.Content);
			setShapeType(REF_AD_PrintFormatItemShapeType.NormalRectangle);
			//
	...
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.Field);
	}
	/**
	 * 	Type Text
	 *	@return true if text
	...
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.Text);
	}
	/**
	 * 	Type Print Format
	...
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.PrintFormat);
	}

	/**
	 * 	Type Account sheet
	 *	@return true if Account sheet
	 */
	public boolean isTypeAccountSheet()
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.Accounting);
	}
	...
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.Image);
	}
	/**
	 * 	Type Box
	 *	@return true if box
	...
	{
		return getPrintFormatType().equals(REF_AD_PrintFormatType.Line)
			|| getPrintFormatType().equals(REF_AD_PrintFormatType.Rectangle);
	}
	...
	{
		return getFieldAlignmentType().equals(REF_AD_PrintFieldAlignment.Center);
	}
	/**
	 * 	Field Align Leading
	...
	{
		return getFieldAlignmentType().equals(REF_AD_PrintFieldAlignment.LeadingLeft);
	}
	/**
	...
	{
		return getFieldAlignmentType().equals(REF_AD_PrintFieldAlignment.TrailingRight);
	}
	/**
	 * 	Field Align Block
	...
	{
		return getFieldAlignmentType().equals(REF_AD_PrintFieldAlignment.Block);
	}
	/**
	 * 	Field Align Default
	...
	{
		return getFieldAlignmentType().equals(REF_AD_PrintFieldAlignment.Default);
	}
	/**
	 * 	Line Align Center
	 *	@return true if center
	...
	{
		return getLineAlignmentType().equals(REF_AD_PrintLineAlignment.Center);
	}
	/**
	 * 	Line Align Leading
	 *	@return true if leading
	...
	{
		return getLineAlignmentType().equals(REF_AD_PrintLineAlignment.LeadingLeft);
	}
	/**
	 * 	Line Align Trailing
	 *	@return true if trailing
	...
	{
		return getLineAlignmentType().equals(REF_AD_PrintLineAlignment.TrailingRight);
	}
	...
	{
		return getPrintAreaType().equals(REF_AD_PrintArea.Header);
	}
	/**
	 * 	Content
	...
	{
		return getPrintAreaType().equals(REF_AD_PrintArea.Content);
	}
	/**
	 * 	Footer
	...
	{
		return getPrintAreaType().equals(REF_AD_PrintArea.Footer);
	}
	...
	public static MPrintFormatItem createFromColumn (MPrintFormat format, int AD_Column_ID, int seqNo)
	{
		...
		pfi.setPrintFormatType(REF_AD_PrintFormatType.Field);
		...
		try
		{
			...
			if (rs.next())
			{
				...
				if (DisplayType.isNumeric(displayType))
					pfi.setFieldAlignmentType(REF_AD_PrintFieldAlignment.TrailingRight);
				else if (displayType == DisplayType.Text || displayType == DisplayType.Memo )
					pfi.setFieldAlignmentType(REF_AD_PrintFieldAlignment.Block);
				else
					pfi.setFieldAlignmentType(REF_AD_PrintFieldAlignment.LeadingLeft);
