 ...
 *
 * @author 	Jorg Janke
 * @version 	$Id: DataEngine.java 5822 2016-06-15 22:56:06Z xapiens $
 * 
		...
		String reportName, String tableName)
	{
		...
		String sql = "SELECT c.AD_Column_ID,c.ColumnName,"				//	1..2
			...
			+ " AND pfi.PrintFormatType IN ('"
				+ REF_AD_PrintFormatType.Field
				+ "','"
				+ REF_AD_PrintFormatType.Image
				+ "','"
				+ REF_AD_PrintFormatType.Accounting
				+ "','"
				+ REF_AD_PrintFormatType.PrintFormat
				+ "') "
