 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: View.java 5822 2016-06-15 22:56:06Z xapiens $
 * 
...
public class View extends CPanel
{
	...
	/** Zoom Options					*/
	public static final String[]	ZOOM_OPTIONS = new String[] {"300%", "200%", "150%", "100%", "75%", "50%"};
	private static HashMap<String, Double> ZOOM_ScaleValues = new HashMap<String, Double>();
	static {
		ZOOM_ScaleValues.put("300%",	3.00);
