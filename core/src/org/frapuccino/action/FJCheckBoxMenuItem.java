...
/**
 * Adds an Observer to JCheckBoxMenuItem in order to make it possible to receive
 * selection state changes from its underlying action.
 *
 * @author fdietz
 */

public class FJCheckBoxMenuItem extends JCheckBoxMenuItem {
	/**
	 * default constructor
	 */
	public FJCheckBoxMenuItem() {
		super();
	}
	 ...
	 */
	public FJCheckBoxMenuItem(AbstractSelectableAction action) {
		super(action);
