...
/**
 * Objects of this class is used to inform observers of the HtmlEditorController
 * about the current format (bold, italic etc.) and other information about the
 * current selection
 *
...
public class FormatInfo {
	...
	/**
	 * Private utility to return the character attributes at the current caret
	 * position. NB: To get the right attributes, caret position - 1 is used!!!
	 */
	...
	/**
	 * Private utility to return the paragraph attributes at the current caret
	 * position
	 */
	...
	/**
	 * Convenience method to determine whether current text is formattet as
	 * heading 1 (H1)
	 *
	 ...
	 *
	 * @param align
	 *            Alignment to check for ("left", "center" or "right")
	...
	/**
	 * Private utility to check whether a given tag is found as parent at the
	 * current caret position. <br>
