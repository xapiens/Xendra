...
/**
 * to use this feature replace: frame.getContentPane().add(toolbar,
 * BorderLayout.NORTH); with
 * frame.getContentPane().add(MoreButton.wrapToolBar(toolBar),
 * BorderLayout.NORTH);
 * 
	...
	private MoreButton(final JToolBar toolbar) {
		...
		toolbar.addComponentListener(new ComponentAdapter() {
			public void componentResized(ComponentEvent e) {
				setVisible(!isVisible(toolbar.getComponent(toolbar
						.getComponentCount() - 1), null));
			}
		});
	}
