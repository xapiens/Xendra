...
import org.columba.core.config.Main;
import org.columba.core.config.Text;
...
public class FontProperties extends Observable implements Observer {
	...
	private static org.columba.core.config.Font fonts; 
    ...
    public FontProperties() {
        ...
        fonts = Config.getInstance().getOptions().getGui().getFonts(); 
        //if (fonts == null) {
    ...
    protected static Font getFont(String id) {
        ...
        if (!overwrite) {
        	...
        	size = String.valueOf(text.getSize());
            font = new Font(name, Font.PLAIN, Integer.parseInt(size));
        }
     ...
     *
     * @see org.xendra.xendrian.Server.core.Gui.config.GeneralOptionsDialog
     *
