...
public class PluginManagerDialog extends JDialog implements ActionListener,
	...
	private PluginManagerDialog() {
		// modal JDialog
		super((JFrame) null, GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "title"), true);
		try {
		...
		if (action.equals("CLOSE")) {
			...
			chooser.addChoosableFileFilter(new FileFilter() {
				...
				public String getDescription() {
					return GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "filefilter");
				}
			});
	...
	protected void installPlugin(File file) {
		...
		File destination = new File(DefaultConfigDirectory.getInstance().getCurrentPath(), "plugins");
		...
		try {
			...
			JOptionPane.showMessageDialog(this, GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "errExtract.msg"),
					GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "errExtract.title"),	JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		if (pluginDirectory != null) {
			...
			JOptionPane.showMessageDialog(this, GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "installSuccess.msg"),
					GlobalResourceLoader.getString(RESOURCE_PATH, "pluginmanager", "installSuccess.title"),
