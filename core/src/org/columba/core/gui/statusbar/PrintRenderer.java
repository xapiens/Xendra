 ...
 * @author fdietz
 */
public class PrintRenderer extends JPanel implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		//X_C_POSLog worker = (X_C_POSLog) value;
		//label.setText(String.valueOf(worker.getAD_LP_ID()));
