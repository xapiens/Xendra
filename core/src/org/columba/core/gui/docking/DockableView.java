...
public class DockableView extends AbstractDockable implements
	...
	public static Color INACTIVE_LABEL_COLOR = UIManager.getColor("Menu.foreground");
	public static Color ACTIVE_LABEL_COLOR = UIManager.getColor("Menu.selectionForeground");
	...
	public DockableView(String id, String title) {
		...
		menuButton = titleBar.addButton(new MenuIcon(), new MenuAction(this.getPersistentId()), BorderLayout.WEST);
		titleBar.addButton(new MaximizeIcon(), new MaximizeAction(this.getPersistentId()), BorderLayout.EAST);
		titleBar.addButton(new CloseIcon(), new CloseAction(this.getPersistentId()), BorderLayout.EAST);
