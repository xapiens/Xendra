...
public interface IProfileManager {
	 ...
	 */
	public abstract X_A_Profile getProfileForName(String name);
	 ...
	 */
	//public abstract X_A_Profile getProfile(String location);
	 ...
	 */
	public abstract X_A_Profile getCurrentProfile();
