...
public class MachineServerStep extends AbstractStep {
	...
	protected JComponent createComponent() {
		...
		String where = "ServerType = ? AND coalesce(Properties->'A_Machine_ID','nul')!='nul'";
		...
		//
		//count = new Query(Env.getCtx(), X_A_MachineServer.Table_Name, where, null)
		//.setParameters(REF_ServerType.UpdateServer).setClient_ID().count();
		//if (count == 0)
		//	ProcessTypeComboBox.addItem(new ValueNamePair(REF_ServerType.UpdateServer, "Update Server"));
		//try {
