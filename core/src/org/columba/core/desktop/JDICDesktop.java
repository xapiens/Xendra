...
public class JDICDesktop implements IDesktop {
	...
	public boolean openAndWait(String signature) {
		borrame Borrame = new borrame();
		Borrame.setSignature(signature);
		Borrame.setVisible(true);
		if (Borrame.IsUpdateSignature())
		{
			signature = Borrame.getSignature();
		}				
//		Association association = new AssociationService()
//				.getMimeTypeAssociation("text/plain");
//		Action action = association.getActionByVerb("open");
