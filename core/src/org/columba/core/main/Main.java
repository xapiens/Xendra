...
public class Main {
	 ...
	 */
	public static MainClassLoader mainClassLoader = new MainClassLoader(Main.class.getClassLoader());
	...
	private static void start(String[] args) throws Exception {
		...
		Bootstrap startup = (Bootstrap) mainClassLoader.loadClass(Bootstrap.class.getName()).newInstance();
		startup.run(args);
