    ...
    public static void passToRunningSessionAndExit(String[] args) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                GlobalResourceLoader.getString(ColumbaServer.RESOURCE_PATH, "session", "err_auth_msg"),
                GlobalResourceLoader.getString(ColumbaServer.RESOURCE_PATH, "session", "err_auth_title"),
