 ...
 * or via info@xendra.org or http://www.xendra.org/license.html         *
 ...
 *
 *  @author Jorg Janke
 *  @version $Id: GenerateModelJPA.java 861 2008-03-19 20:38:57Z el_man $
 */
public class GenerateModelJPA
{
	...
	private String createHeader (int AD_Table_ID, StringBuffer sb, StringBuffer mandatory, String packageName)
	{
		...
		start.append("import java.util.*;"
			...
			+ " *  @version ").append(Xendra.MAIN_VERSION).append(" - ").append(s_run).append(" */\n"
                        + " @Entity"
