...
import static org.compiere.model.persistence.X_AD_Ref_Table.COLUMNNAME_AD_Reference_ID;
import static org.compiere.model.persistence.X_AD_Ref_Table.COLUMNNAME_OrderByClause;
import static org.compiere.model.persistence.X_AD_Ref_Table.COLUMNNAME_WhereClause;
...
import org.xendra.exceptions.PORelationException;
...
import org.compiere.model.persistence.X_AD_RelationType;
...
public class MRelationType extends X_AD_RelationType implements IZoomProvider {
	...
	public static List<MRelationType> retrieveTypes(final PO po,
		...
		final int colId = MColumn.getColumn_ID(po.get_TableName(), keyColumn, po.get_TrxName());
	...
	public X_AD_Reference getAD_Reference_Target() throws RuntimeException
    {
		return (X_AD_Reference)MTable.get(getCtx(), X_AD_Reference.Table_Name)
	...
	public static MRefTable retrieveRefTable(final Properties ctx,
		...
		final MRefTable refTable = new Query(ctx, X_AD_Ref_Table.Table_Name, COLUMNNAME_AD_Reference_ID + "=?", trxName)
