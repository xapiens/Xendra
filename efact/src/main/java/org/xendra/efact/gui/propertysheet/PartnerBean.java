...
public class PartnerBean {
	...
	public void setReceivefilespath(String receivefilespath) {
		this.receivefilespath = receivefilespath;
	}
	...
	public String getPDFReportLogo() {
		return PDFReportLogo;
	}
	public void setPDFReportLogo(String pDFReportLogo) {
		PDFReportLogo = pDFReportLogo;
	}
