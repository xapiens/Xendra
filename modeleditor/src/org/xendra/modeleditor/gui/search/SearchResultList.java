package org.xendra.modeleditor.gui.search;
...
import org.xendra.modeleditor.facade.DialogFacade;
...
public class SearchResultList extends JXList {
	...
	public SearchResultList() {
		...
		setBorder(null);
		setHighlighters(new HighlighterPipeline(new Highlighter[] { new RolloverHighlighter(new Color(248, 248,	248), Color.white) }));
