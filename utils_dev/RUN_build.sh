...
echo Building ...
$JAVA_HOME/bin/java   -Xmx1000m  -Dant.home="." $ANT_PROPERTIES org.apache.tools.ant.Main -logger org.apache.tools.ant.listener.MailLogger complete
