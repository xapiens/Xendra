...
public class MessageServerStep extends AbstractStep implements ActionListener {
	...
	protected JComponent createComponent() {
		...
		WizardTextField POPListPanel = new WizardTextField();
		...
		POPListPanel.addTextField(cbMachineMessageServer);
		POPListPanel.addEmptyExample();
		component.add(POPListPanel);
		Method method = null;		
