...
public class ExportSessionDirectory extends AbstractStep implements ActionListener {	
	protected DataModel data;
	private JTextField textdirectory;
	private JButton button;
	private File m_filename;
	
	public ExportSessionDirectory(DataModel data) {		
		super(ResourceLoader.getString("dialog", "exportsessionwizard", "identity"),
				ResourceLoader.getString("dialog", "exportsessionwizard",   "identity_description"));		
		this.data = data;		
		setCanGoNext(false);
	}
	...
	protected JComponent createComponent() {
        ...
        data.registerDataLookup(X_AD_Table_Access.COLUMNNAME_IsCanExport,new DefaultDataLookup(textdirectory, method, null));        
