...
public class NewChannel extends AbstractStep {
	protected DataModel data;
	protected JTextField channelName;
	
	public NewChannel(DataModel data) {
	...
	protected JComponent createComponent() {
        ...
        try {
            method = channelName.getClass().getMethod("getText", null);
        } catch (NoSuchMethodException nsme) {}
        data.registerDataLookup(X_AD_Rule.COLUMNNAME_Name,new DefaultDataLookup(channelName, method, null));        
		middlePanel.addTextField(channelName);
