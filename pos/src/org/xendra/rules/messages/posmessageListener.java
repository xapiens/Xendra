...
public class posmessageListener implements MessageListener {

	private Integer m_AD_MessageFormat_ID;
	private Integer m_AD_Rule_ID;
	private String m_tag;	
	public posmessageListener(Integer AD_MessageFormat_ID, Integer AD_Rule_ID, String tag) {
			...
			public void run() {
				try {
					...
					if (msqueue == null)
					{
						...
						queue.setAD_MessageFormat_ID(m_AD_MessageFormat_ID);
