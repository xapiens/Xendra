...
public class AcceptSales extends SvrProcess {
	...
	protected String doIt() throws Exception {
		log.log(Level.WARNING, "ejecutando AcceptorSales");		
		...
		if (format == null) {			
			throw new Exception(String.format("format not found in %s AcceptSales", proc.getName()));			
		}		
		...
		System.out.println("terminado AcceptorSales");
		return null;
	}
