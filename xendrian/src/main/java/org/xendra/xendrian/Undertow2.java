...
public final class Undertow2 {
    ...
    private Undertow2(Builder builder) {
    ...
    public synchronized void start() {
        xnio = Xnio.getInstance(Undertow2.class.getClassLoader());
    ...
    public static final class Builder {
        ...
        public Undertow2 build() {
            return new Undertow2(this);
        }
